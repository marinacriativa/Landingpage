                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                        style="line-height: 39.2px; font-size: 28px;"><span
                                                                            style="font-size: 26px; line-height: 36.4px;">Pedido de contacto</span></span></strong></span>
                                                    </p>
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px 40px 25px;font-family: 'Montserrat', sans-serif;"
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <span style="font-size: 16px; line-height: 27.2px;">Nome: {{ $name }} {{ $surname }}</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <span style="font-size: 16px; line-height: 27.2px;">Email: {{ $email }}</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <span style="font-size: 16px; line-height: 27.2px;">Contacto: {{ $contact }}</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <span style="font-size: 16px; line-height: 27.2px;">Assunto: {{ $subject }}</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <span style="font-size: 16px; line-height: 27.2px;">Mensagem: {{ $description }}</span>
                                                    </p>
                                                </div>
