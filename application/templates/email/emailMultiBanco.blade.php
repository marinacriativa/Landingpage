...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,200;0,300;0,400;1,200&display=swap"
          rel="stylesheet">
    <!--<![endif]-->
...
<table style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #ECF0F1;width:100%"
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row"
                     style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #92817A;">
                            ...
                            <tr>
                                <td style="padding: 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: #92817A;"><![endif]-->
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table id="u_content_image_1" style="font-family: 'Montserrat', sans-serif;"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:31px 10px 25px;font-family: 'Montserrat', sans-serif;"
                                                align="left">
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table id="u_content_text_1" style="font-family: 'Montserrat', sans-serif;"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:13px 26px 16px;font-family: 'Montserrat', sans-serif;"
                                                align="left">

                                                <div class="v-text-align"
                                                     style="color: #ffffff; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                style="font-size: 14px; line-height: 19.6px;">{{$store_name}}</span>
                                                    </p>
                                                </div>
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                        style="line-height: 39.2px; font-size: 28px;"><span
                                                                            style="font-size: 26px; line-height: 36.4px;">Referência Multibanco</span></span></strong></span>
                                                    </p>
                                                </div>
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p dir="ltr"
                                                       style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <p style="font-size: 16px; line-height: 27.2px;">Referência: {{$reference}}</p>
                                                        <p style="font-size: 16px; line-height: 27.2px;">Entidade: {{$entity}}</p>
                                                        <p style="font-size: 16px; line-height: 27.2px;">Valor: {{$value}}€</p>
                                                    </p>
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family: 'Montserrat', sans-serif;" align="left">
                                                ...
                                                <div class="v-text-align" style="color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;">Esta referência é relativo ao pagamento da encomenda <b>{{$order_number}}</b></p>
                                                </div>
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:26px 10px 10px;font-family: 'Montserrat', sans-serif;"
                                                align="left">
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                style="font-size: 24px; line-height: 33.6px;"><strong><span
                                                                        style="line-height: 33.6px; font-size: 24px;">Para visualizar aos dados da encomenda aceda a:</span></strong></span>
                                                    </p>
                                                </div>
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px;font-family: 'Montserrat', sans-serif;"
                                                align="left">
                                                ...
                                                <div class="v-text-align" align="center">
                                                        ...
                                                        <tr>
                                                            <td class="v-text-align"
                                                                ...
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                             ...
                                                                             href=""
                                                                             style="height:46px; v-text-anchor:middle; width:302px;"
                                                                             arcsize="87%"
                                                    ...
                                                    <a href="{{$link}}" target="_blank"
                                                       style="box-sizing: border-box;display: inline-block;font-family: 'Montserrat', sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #92817A; background-color: #ffffff; border-radius: 40px; -webkit-border-radius: 40px; -moz-border-radius: 40px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                        <span style="display:block;padding:15px 40px;line-height:120%;"><strong><span
                                                                        style="font-size: 14px; line-height: 16.8px;">{{$link}}</span></strong></span>
                                                    </a>
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:35px 10px 10px;font-family: 'Montserrat', sans-serif;"
                                                align="left">

                                                <div class="v-text-align"
                                                     style="color: #92817A; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><strong><span
                                                                    style="font-size: 30px; line-height: 42px;">{{$store_name}}</span></strong>
                                                    </p>
                                                </div>
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px 40px 15px;font-family: 'Montserrat', sans-serif;"
                                                align="left">

                                                <div class="v-text-align"
                                                     style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 170%; text-align: center;">
                                                        <em><span style="font-size: 14px; line-height: 23.8px;">Por favor, não responda a este email.
O endereço de envio serve apenas para transmitir mensagens automáticas. Para entrar em contacto connosco <a href="{{$linkContact}}">clique aqui</a> . </span></em>
                                                    </p>
                                                </div>
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:9px 9px 31px;font-family: 'Montserrat', sans-serif;"
                                                align="left">
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table style="font-family: 'Montserrat', sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:16px;font-family: 'Montserrat', sans-serif;"
                                                align="left">

                                                <div class="v-text-align"
                                                     style="color: #ecf7ff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;">&copy; Criativatek
                                                        </p>
                                                </div>
