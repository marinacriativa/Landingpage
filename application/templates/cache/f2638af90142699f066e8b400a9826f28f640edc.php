...
<section id="main" class="main">
    ...
    <div class="container-fluid fullheight">
      <div class="main-intro col-xs-12 col-md-8 col-lg-9" style="background-image:url(/static/images/backgrounds/bg-main-color-2.jpg);">
        ...
        <div class="logo">
          <img src="/static/images/logo.png" alt="Coliworld - awesome coming soon template to kick-start your project">
        </div>
        <div class="menu">
          <nav>
            <ul>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\frontoffice/pages/main.blade.php ENDPATH**/ ?>