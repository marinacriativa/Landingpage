<h4 class="w-100"><?php echo e(ucfirst($translations["backoffice"]["faqs_title"])); ?>


<div class="btn-group top-right-button-container">
        <a href="#" class="btn btn-xs btn-outline-secondary add-new-faq"><?php echo e(ucfirst($translations["backoffice"]["faqs_btn_create"])); ?></a>
        <?php 
            $countLangs = 0;
        ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <form>
                        <div class="row">
                            <div class="form-group col mb-6">
                                <label><?php echo e(ucfirst($translations["backoffice"]["faqs_fill_title"])); ?></label>
                                <input id="titleFaq" name="title" type="text" autocomplete="off" class="form-control" placeholder="Como registar?">
                            </div>
                        </div>
                        <div class="form-group mb-6">
                            <label><?php echo e(ucfirst($translations["backoffice"]["faqs_fill_language"])); ?></label>
                            <select name="lang" class="form-control">
                            </select>
                        </div>
                        <label class="form-group ckeditor has-float-label"><?php echo e(ucfirst($translations["backoffice"]["faqs_fill_description"])); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light btn-sm" data-dismiss="modal"><?php echo e(ucfirst($translations["backoffice"]["faqs_btn_cancel"])); ?></button>
                <button type="button" class="btn btn-primary btn-sm save-faqs" data-id=""><?php echo e(ucfirst($translations["backoffice"]["faqs_btn_save"])); ?></button>
            </div>
        </div>
    </div>
</div>
    ...
    function faqs() {
        ...
        function removeFaq(id) {
            ...
            $.confirm({
                ...
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations["backoffice"]["confirm_message_remove_faq"])); ?>',
                buttons: {
...
<?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/faqs.blade.php ENDPATH**/ ?>