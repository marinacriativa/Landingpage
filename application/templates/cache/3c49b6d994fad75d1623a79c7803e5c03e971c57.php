...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
	<div class="p-desktop-5">
		<div class="row">
			<div class="col-12">
				<div class="mb-3">
					<h1><?php echo e(ucfirst($translations["backoffice"]["title_list_blog"])); ?></h1>
					...
					<div class="text-zero top-right-button-container">
						<div class="btn-group">
							<a type="button" class="btn btn-primary top-center-button mr-1" data-action="create" href="javascript:void(0)" style="padding: 9px 34px;"><?php echo e(ucfirst($translations["backoffice"]["list_blog_create"])); ?></a>
						</div>
					</div>				
					<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
						<ol class="breadcrumb pt-0">
							...
							<li class="breadcrumb-item active" aria-current="page">
								<?php echo e(ucfirst($translations["backoffice"]["blog"])); ?>
					...
					<div class="collapse d-md-block" id="displayOptions">
						<div class="d-block d-md-inline-block">
							<div class="btn-group float-md-left mr-1 mb-1">
								<button class="btn btn-outline-dark btn-xs dropdown-toggle clients-order-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(ucfirst($translations["backoffice"]["order_by"])); ?></button>
								<div class="dropdown-menu">
									<a class="dropdown-item order-menu" data-order="id"><?php echo e(ucfirst($translations["backoffice"]["orderBy_last_inserted"])); ?></a>
									<a class="dropdown-item order-menu" data-order="date"><?php echo e(ucfirst($translations["backoffice"]["orderBy_date"])); ?></a>
								</div>
							</div>
						...
						<div class="float-md-right">
							<span class="text-muted text-small mr-1"><?php echo e(ucfirst($translations["backoffice"]["items_per_page"])); ?></span><button class="btn btn-outline-dark btn-xs dropdown-toggle news-lenght-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">10</button>
	...
	<div class="d-flex flex-row pl-5 pr-5">
		<p class="w-10 w-md-100 mb-0"></p>
		<p class="w-50 w-md-100 mb-0">Nome</p>
		<p class="w-15 w-sm-100 mb-0">Estado</p>
		<p class="w-15 w-sm-100 mb-0">Data</p>
		<p class="w-15 w-sm-100 mb-0"></p>
	</div>
		<div class="row">
...
<script>
	...
	*/
	...
	function load() {
		...
		window.history.replaceState("", "", '/adm/news?' + $.param( { limit: limit, order: order, page: page, search: search } ));
    
	    $.ajax({
	        url: "/api/news?page=" + page + "&search=" + search + "&length=" + limit + "&order=" + order,
	        type: "GET",
	        dataType : "json",
	...
	function populate(items) {
		...
		if (items === undefined || items.length == 0) {
			...
			$(".list").html(`
				<h4><?php echo e(ucfirst($translations["backoffice"]["not_found_female"])); ?></h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/news/index.blade.php ENDPATH**/ ?>