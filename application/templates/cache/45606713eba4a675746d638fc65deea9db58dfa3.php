...
<section id="main" class="main">
    ...
    <div class="container-fluid fullheight">
      <div class="main-intro col-xs-12 col-md-8 col-lg-9" style="background-image:url(/static/images/backgrounds/bg-main-color-2.jpg);">
        ...
        <div class="headline">
          ...
          <p class="additional-text">INDÚSTRIA DOS MOLDES - Serviços | Peças</p>
          <h1 class="main-headline clip">
            <span class="words-wrapper">
              <b class="is-visible">Em manutenção<br> </b>

              <b>Website</b>
              <b>Em manutenção</b>
            </span>
          </h1>
          <p class="description-text">Estamos a preparar algo fantástico. Brevemente disponível...</p>
      ...
      <div class="main-aside col-xs-12 col-md-4 col-lg-3">
        <div class="aside-content" >
          <p><b>ONDE NOS ENCONTRAMOS:</b></p><br>
          <p><a href="https://goo.gl/maps/kJ2ErZqGWVCs2B3C9"><i class="fa fa-map"></i>&nbsp; Estrada Principal, Cerca
          <br>&nbsp; &nbsp; &nbsp;  Apartado 47 - 2405-909 Maceira Lis</i></a></p>
          <p><a href="tel:+351-244777692"><i class="fa fa-phone"></i>&nbsp; +351 244 777 692</a><br><small>*(Chamada para rede fixa nacional)</small></p>
          <p><a href = "mailto: joferlis@gmail.com"><i class="fa fa-envelope"></i>&nbsp; joferlis@gmail.com</a></p>
  ...
  <section id="about" class="content-section about">
    <div class="container-fluid">
      ...
      <div class="section-title">
        ...
        <p>A tecnologia e experiência ao serviço dos moldes.</p>
      </div>
      <div class="about-features">
        <div class="col-xs-12 no-padding">
          <div class="col-xs-12 col-sm-6 feature-image feature-image-1" style="background-image:url(/static/images/backgrounds/bg-main-color-2.jpg);"></div>
          <div class="col-xs-12 col-sm-6 feature-description">
            <div class="feature-item">
              <!-- <i class="icon feature-icon feature-icon-1"></i> -->
              <h3>A tecnologia e experiência ao serviço dos moldes.</h3>
              <p>Mais do que usinar e retificar, resolva problemas e cumpra prazos. Com turnos vinte e quatro horas, um parque com mais de doze CNC's e quatro toneladas de aço em stock esforçamo-nos por dar resposta aos nossos clientes.</p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/joferlis/public_html/application/templates/frontoffice/pages/main.blade.php ENDPATH**/ ?>