        ...
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-md-12 mb-8">
                    <div class="col-12">
                        <h1><?php echo e(ucfirst($translations['backoffice']['title_edit_news'])); ?></h1>
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/adm/news"><?php echo e(ucfirst($translations['backoffice']['blog'])); ?></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo e(ucfirst($translations['backoffice']['title_edit_news'])); ?></li>
                            </ol>
                        </nav>
                        <div class="btn-group top-right-button-container">
                            <button type="button" href="javascript:void(0)"
                                onclick='javascript:window.location.assign("/adm/news");'
                                class="btn btn-outline-secondary"><?php echo e(ucfirst($translations['backoffice']['edit_custom_btn_back'])); ?></button>
                            <?php
                                $countLangs = 0;
                            ?>
                            ...
                            <?php if($countLangs > 1): ?>
                                <button id="btnGroupDrop1" type="button"
                                    class="btn btn-secondary dropdown-toggle dropdown-menu-status-index language-selected"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-8 col-sm-12 col-xs-12 mb-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5><i
                                                    class="simple-icon-book-open mr-2"></i><?php echo e(ucfirst($translations['backoffice']['edit_news_content'])); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-group has-float-label">
                                                        ...
                                                        <span><?php echo e(ucfirst($translations['backoffice']['edit_news_fill_name'])); ?></span>
                                                    </label>
                                                </div>
                                                <br>
                                                <div class="col-12">
                                                    <label class="form-group has-float-label">
                                                        <input name="date" type="date" autocomplete="off"
                                                            class="form-control">
                                                        <span><?php echo e(ucfirst($translations['backoffice']['edit_news_fill_date'])); ?></span>
                                                    </label>
                                                </div>
                                                <br>
                                                <div class="col-12">
                                                    <label class="form-group has-float-label">
                                                        <input id="resume" name="resume" type="text"
                                                            autocomplete="off" class="form-control">
                                                        <span><?php echo e(ucfirst($translations['backoffice']['edit_news_fill_resume'])); ?></span>
                                                    </label>
                                                </div>
                                                <br>
                                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="mb-3"><i
                                                    class="simple-icon-grid mr-2"></i><?php echo e(ucfirst($translations['backoffice']['edit_product_fill_gallery'])); ?>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="w-100">
                                                <h5><i
                                                        class="simple-icon-organization mr-2"></i><?php echo e(ucfirst($translations['backoffice']['edit_news_seo_tags'])); ?>

                                                </h5>
                                                <hr>
                                                <div class="form-group mt-4">
                                                    <label class="form-group has-float-label">
                                                        <input name="slug" type="text" autocomplete="off"
                                                            class="form-control">
                                                        <span><?php echo e(ucfirst($translations['backoffice']['edit_news_fill_url_friendly'])); ?></span>
                                                    </label>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label class="form-group has-float-label">
                                                        <input type="text" name="keywords" class="form-control">
                                                        <span><?php echo e(ucfirst($translations['backoffice']['edit_news_fill_tags'])); ?></span>
                                                    </label>
                                                </div>
                                                <div class="row mt-2">
                                                        ...
                                                        <div class="widget-body">
                                                            <div class="seo-preview">
                                                                ...
                                                                <div class="page-url-seo ws-nm">
                                                                    <p><?php echo e(URL); ?><?php echo e($selected_language->code); ?>/news/<span
                                                                            data-fill="slug"></span></p>
                                                                </div>
                                                                <div class="ws-nm">
                                                                    <span style="color: #70757a;" data-fill="date"></span>
                                                                    <span data-fill="details"
                                                                        class="page-description-seo"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-md-12 col-xl-4 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-12">
                                            <div class="card-body">
                                                <button type="button" data-action="delete"
                                                    class="btn btn-xs btn-outline-danger m-1"><?php echo e(ucfirst($translations['backoffice']['edit_news_btn_remove'])); ?></button>
                                                <button type="button" data-action="save"
                                                    class="btn btn-xs btn-outline-info m-1"><?php echo e(ucfirst($translations['backoffice']['edit_news_btn_save'])); ?></button>
                                                <div class="form-group mt-3">
                                                    <label><?php echo e(ucfirst($translations['backoffice']['edit_product_fill_highlight'])); ?></label>
                                                    <div
                                                        class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
                                                        <input class="custom-switch-input" id="featuredSwitch"
                                                            type="checkbox"> <label rel="tooltip"
                                                            title="Destacado na página principal"
                                                            class="custom-switch-btn" for="featuredSwitch"></label>
                                                    </div>
                                                </div>
                                                <div class="form-group mt-4">
                                                    <label><span class="dot green mr-2"></span>
                                                        <?php echo e(ucfirst($translations['backoffice']['edit_news_status'])); ?></label>
                                                    <select name="status" class="form-control">
                                                        <option value="2">
                                                            <?php echo e(ucfirst($translations['backoffice']['news_status_published'])); ?>

                                                        </option>
                                                        <option value="1">
                                                            <?php echo e(ucfirst($translations['backoffice']['news_status_private'])); ?>

                                                        </option>
                                                        <option value="0">
                                                            <?php echo e(ucfirst($translations['backoffice']['news_status_draft'])); ?>
                                    ...
                                    <div class="card">
                                        <div class="col-12">
                                            <div class="card-body">
                                                <h5><i
                                                        class="simple-icon-list mr-2"></i><?php echo e(ucfirst($translations['backoffice']['categories'])); ?>
    ...
    <script>
        ...
        function save(id = "", data) {
            ...
            $.confirm({
                ...
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations['backoffice']['confirm_message_save_news'])); ?>',
                buttons: {
                    Sim: function() {
                        $.ajax({
                            url: "/api/news/" + id,
        ...
        function load(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Carregar as linguas
                    languages(response.data.related, {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.data = response.data.filter(function(category) {
                        if (category.lang == lang && category.root !== "1" && category.parent !==
                            null) {
                            return true;
                        }
                        return false;
        ...
        function populateCategories(categories, lang, selected_categories) {
            ...
            $.each(categories, function(key, category) {
                let isFather = (category.root == "1") ? `<span>` + category.name + `</span>` : `<input  ` + (
                        selected.includes(category.id) ? "checked" : "") +
                    ` class="mt-2 mr-2 ml-2" type="checkbox">` + category.name + ``
        ...
        function languages(related, selected_language) {
            ...
            $.each(active, function(key, lang) {
                ...
                if (lang.item_id == null) {
                    ...
                    button =
                        `<a href="javascript:void(0)" style="min-width: 80px" class="btn btn-success btn-xs float-right"><?php echo e(ucfirst($translations['backoffice']['language_btn_current'])); ?></a>`;
                    $(".language-selected").append(`
                    ` + lang.name + `
                `);
                } else {
                    button = `<a href="/adm/news/` + lang.item_id +
                        `" style="min-width: 80px" class="btn btn-info btn-xs float-right"><?php echo e(ucfirst($translations['backoffice']['language_btn_see'])); ?></a>`;
                }
                let status = "";
                switch (lang.status) {
                    case "0":
        ...
        function icon(type) {
            switch (type) {
                case "video":
                    return {
                        icon: "simple-icon-film", single: "Video", plural: "Videos"
                    };
                    break;
                case "audio":
                    return {
                        icon: "simple-icon-music-tone-alt", single: "Audio", plural: "Audios"
                    };
                    break;
                case "file":
                    return {
                        icon: "simple-icon-paper-clip", single: "Ficheiro", plural: "Ficheiros"
                    };
                    break;
                case "doc":
                    return {
                        icon: "simple-icon-doc", single: "Documento", plural: "Documentos"
                    };
                    break;
                case "pdf":
                    return {
                        icon: "simple-icon-doc", single: "Pdf", plural: "Pdfs"
                    };
                    break;
                case "compress":
                    return {
                        icon: "simple-icon-layers", single: "Pasta comprimida", plural: "Pastas comprimidas"
                    };
                    break;
                case "image":
                    return {
                        icon: "simple-icon-picture", single: "Imagem", plural: "Imagens"
                    };
                    break;
            }
            return false;
        ...
        function listners() {
            ...
            $("body").on('click', ".tui-image-editor-save-btn", function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/api/image/edit_news?id=' + id + '&new_file_name=' + encodeURIComponent(
                        imageThatIsBeingEdited),
                    data: fd,
                    processData: false,
                    contentType: false,
        ...
        function createAnotherLanguage(lang, name) {
            ...
            $.confirm({
                title: name,
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations['backoffice']['confirm_create_product_another_language'])); ?>',
                buttons: {
                    Sim: function() {
                        $.ajax({
                            url: "/api/news/",
        ...
        function remove(id) {
            $.confirm({
                title: '<?php echo e(ucfirst($translations['backoffice']['confirm'])); ?>',
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations['backoffice']['confirm_message_news_remove'])); ?>',
                buttons: {
                    Sim: function() {
                        $.ajax({
                            url: "/api/news/" + id,
        ...
        function imageEditor(image) {
            ...
            $('.tui-image-editor-header-buttons .tui-image-editor-download-btn').replaceWith(
                '<button style="background-color: #fff; border: 1px solid #ddd; color: #222;" class="tui-image-editor-save-btn" ><?php echo e(ucfirst($translations['backoffice']['editor_image_save'])); ?></button>'
            );
            $('.tui-image-editor-header-buttons').children().first().replaceWith(
                '<button class="tui-image-editor-close-btn" ><?php echo e(ucfirst($translations['backoffice']['editor_image_cancel'])); ?></button>'
            );
            ...
            $(".dropzone").dropzone({
                ...
                init: function() {
                    ...
                    let sortable_dropzone = new Sortable($(".dropzone").get(0), {
                        ...
                        store: {
                            set: function(sortable) {
                                ...
                                $.ajax({
                                    url: "/api/image/order?ids=" + order.join(",") +
                    ...
                    this.on("complete", function(data) {
                        ...
                        if (data.hasOwnProperty('xhr')) {
                            ...
                            if (server_data.data.path != undefined) {
                                setTimeout(() => {
                                    data.previewElement.parentNode.removeChild(data
                                        .previewElement);
                                    ...
                                    thisDropzone.emit("thumbnail", mockFile, (thumbnail(
                                        extension) === false) ? file.path : thumbnail(
                                        extension));
                    ...
                    this.on("addedfile", function(data) {
                        ...
                        $(data.previewElement).find(".download").data("name", data.name + "." + data
                            .extension);
                    ...
                    if (files.length > 0) {
                        $.each(files, function(key, file) {
                            ...
                            let extension = filetype(file.path);
                            thisDropzone.emit("addedfile", mockFile);
                            thisDropzone.emit("thumbnail", mockFile, (thumbnail(extension) === false) ?
                                file.path + "?nocache=" + (new Date().getTime()) : thumbnail(
                                    extension));
                            thisDropzone.files.push(mockFile);
                        });
                    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/news/page.blade.php ENDPATH**/ ?>