...
<section id="main" class="main">
  <style>
    ...
    <div class="container-fluid fullheight">
      <div class="main-intro col-xs-12 col-md-8 col-lg-9" style="background-image:url(/static/images/backgrounds/bg2.jpg);">
        <div class="layer-black"></div>
        <div class="logo">
          <img src="/static/images/logo.png" alt="Joferlis - awesome coming soon template to kick-start your project">
        </div>
        <div class="menu">
          <nav>
            <ul>
        ...
        <div class="headline">
          <p class="additional-text" style="padding-top: 2rem;">MADEIRAS | IMOBILIÁRIA RURAL</p>
          <h1 class="main-headline clip">
            <span class="words-wrapper" style="padding-bottom: 2rem; padding-top: 2rem;">
              <b class="is-visible">Florestas - Madeiras</b>
              
              <b>Imobiliária Rural</b>
              <b>Serviços Imobiliários</b>
              <b>Valorização de imóveis</b>
            </span>
          </h1>
          <p class="description-text">Estamos a preparar algo para criar a melhor experiência de navegação. Brevemente disponível...</p>
      ...
      <div class="main-aside col-xs-12 col-md-4 col-lg-3">
        <div class="aside-content" >
          ...
          <p><a href="https://goo.gl/maps/kJ2ErZqGWVCs2B3C9"><i class="fa fa-map"></i>&nbsp; Av. Heróis do Ultramar, Nº 71, 3100-462 Pombal</i></a></p>
          <p><a href="tel:+351-964957116"><i class="fa fa-phone"></i>&nbsp; +351 236 214 145 | +351 964 957 116</a><br><small>*(Chamada para rede fixa nacional)</small></p>
          <p><a href = "mailto: joferlis@gmail.com"><i class="fa fa-envelope"></i>&nbsp; info@madeiluz.pt</a></p>
        ...
        <div class="stayintouch">
          ...
          <div class="form-container">
            ...
            <form class="form form-light no-padding" id="stayintouch-form" class="form">
              <input type="hidden" name="project_name" value="Joferlis - Moldes e acessórios">
              ...
              <div style="color: white;">
                <input style="-webkit-appearance:checkbox;" type="checkbox" name="terms" id="terms" data-required></input> Autorizo o tratamento pela Joferlis dos meus dados pessoais nos termos do Regulamento Geral de Proteção de Dados (RGPD)
            </div>
            <br>
    ...
    <div class="container-fluid">
      ...
      <div class="section-title">
        <h2 class="second-edit">
          <span style="color: #018938 ;">Bem-vindo</span>
          <!-- <span style="font-weight: 600;">Joferlis</span> -->
        </h2>
        <p>Madeiluz - desde 1990</p>
      </div>
      <div class="about-features">
        <div class="col-xs-12 no-padding">
          <div class="col-xs-12 col-sm-4 feature-image feature-image-1" style="background-image:url(/static/images/backgrounds/bg-main-color-2.jpg);"></div>
          <div class="col-xs-12 col-sm-8 feature-description">
            <div class="feature-item">
              <!-- <i class="icon feature-icon feature-icon-1"></i> -->
              <h3>A tecnologia e experiência ao serviço dos moldes.</h3>
              <p>Uma empresa líder de mercado na industria das Madeiras com Serviços técnicos Profissionais tais como Cadastro / Levantamentos / FGF e Planos de Arborização</p>
              <p>A Madeiluz é especialista na área da imobiliária Rural. Consulte os nossos serviços, assim como os nossos imóveis</p>
              <p>Nós valorizamos o seu imóvel, criamos projetos 3D, Habitações rurais de madeira e chapa a Baixo custo assim como recuperação de casas antigas</p>
              <p>Consulte-nos para mais informações</p>
              <!-- <p>Through awareness, we hope that living beings can cooperate and develop in simbiosis.</p> -->
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\madeiluzLandingpage\application\templates\frontoffice/pages/main.blade.php ENDPATH**/ ?>