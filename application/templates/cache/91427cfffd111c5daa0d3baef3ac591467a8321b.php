...
<div class="row">
    <div class="col-12 mt-4">
        <button type="button" class="btn btn-outline-primary btn-xs float-right save-scripts-settings"><?php echo e(ucfirst($translations["backoffice"]["store_settings_btn_save"])); ?></button>
    </div>
</div>
...
</script><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/scripts.blade.php ENDPATH**/ ?>