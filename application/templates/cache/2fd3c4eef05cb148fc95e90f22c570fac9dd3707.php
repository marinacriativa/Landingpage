    ...
    <main class="default-transition pt-5 mb-5 collapsable-main no-load">
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1><?php echo e(ucfirst($translations["backoffice"]["banner_title"])); ?></h1>
                        ...
                        <div class="btn-group top-right-button-container m-2">
                            <a href="javascript:void(0)" data-action="newProduct" type="button" class="btn btn-primary add-new-banners  botaodrop"><?php echo e(ucfirst($translations["backoffice"]["banner_btn_create"])); ?></a>
                            <?php 
                                $countLangs = 0;
                            ?>
                            ...
                            <?php endif; ?>
                            <?php if($countLangs > 1): ?>
                                <button id="btnGroupDrop1" type="button" class="btn btn-secondary dropdown-toggle botaodrop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span id="c_lang"><?php echo e($selected_language->name); ?></span> </button>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo e(ucfirst($translations["backoffice"]["banner_title"])); ?>                                    
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="d-block d-md-inline-block">
                                <div class="btn-group float-md-left mr-1 mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item order-menu" data-order="order_by"><?php echo e(ucfirst($translations["backoffice"]["orderBy_last_inserted"])); ?></a>
                                        <a class="dropdown-item order-menu" data-order="title"><?php echo e(ucfirst($translations["backoffice"]["orderBy_name"])); ?></a>
                                        <a class="dropdown-item order-menu" data-order="active"><?php echo e(ucfirst($translations["backoffice"]["orderBy_status"])); ?></a>
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form>
                                ...
                                <div class="form-group mt-2">
                                    <label class="form-group has-float-label"><input name="title" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_title"])); ?></span></label>
                                </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><input name="subtitle" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_subTitle"])); ?></span></label>
                               </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><input name="description" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_description"])); ?></span></label>     
                                </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><input name="button_text" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_btn_text"])); ?></span></label>     
                                </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><input name="link" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_url"])); ?></span></label> 
                                </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><input name="duration" class="form-control"><span>Duração em milissegundos</span></label> 
                                </div>
                                <div class="form-group">
                                    <label class="form-group has-float-label"><select name="lang" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["banner_fill_language"])); ?></span></label>
                                    </select>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="color-dark-grey-new"><?php echo e(ucfirst($translations["backoffice"]["banner_text_color_dark_grey"])); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
    ...
    function populatebanners(items) {
            ...
            if (items === undefined || items.length == 0) {
                ...
                $(`.banners-method-list`).html(`
                	<h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["banner_title"]); ?></h4>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/banners/index.blade.php ENDPATH**/ ?>