<h4 class="inline"><?php echo e(ucfirst($translations["backoffice"]["menu_manager"])); ?></h4>
<hr>
...
function menu_manager() {
    ...
    function addMenu(parent_id) {
        ...
        $.confirm({
            ...
            title: "<?php echo e(ucfirst($translations["backoffice"]["menus_create_title"])); ?>",
            theme: "supervan",
            content: '' +
            '<form action="" class="formName">' +
            '<div class="form-group">' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["menus_fill_name"])); ?></label>' +
            '<input type="text" placeholder="<?php echo e(ucfirst($translations["backoffice"]["menus_placeholder_name"])); ?>" class="name form-control" required /> <br>' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["url_fill_name"])); ?></label>' +
            '<input type="text" placeholder="<?php echo e(ucfirst($translations["backoffice"]["menus_placeholder_url"])); ?>" class="url form-control" required /> <br>' +
            '<input type="checkbox" id="newtab" name="newtab"> ' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["newtab"])); ?></label>' +
            '</div>' +
            '</form>',
            buttons: {
                formSubmit: {
                    text: '<?php echo e(ucfirst($translations["backoffice"]["menus_btn_save"])); ?>',
                    action: function () {
                        ...
                        if (!name) {
                            ...
                            $.alert({
                                title: '<?php echo e(ucfirst($translations["backoffice"]["error"])); ?>',
                                theme: "supervan",
                                content: '<?php echo e(ucfirst($translations["backoffice"]["error_message_menus_fill_name_invalid"])); ?>',
                            });
                            ...
                            $.alert({
                                title: '<?php echo e(ucfirst($translations["backoffice"]["error"])); ?>',
                                theme: "supervan",
                                content: '<?php echo e(ucfirst($translations["backoffice"]["error_message_menus_fill_url_invalid"])); ?>',
                            });
    ...
    function editMenu(id, old_name, old_url, oldtab) {
        ...
        $.confirm({
            ...
            title: "<?php echo e(ucfirst($translations["backoffice"]["menus_edit_title"])); ?>",
            theme: "supervan",
            content: '' +
            '<form action="" class="formName">' +
            '<div class="form-group">' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["menus_fill_name"])); ?></label>' +
            '<input type="text" placeholder="<?php echo e(ucfirst($translations["backoffice"]["menus_placeholder_name"])); ?>" value="' + old_name + '" class="name form-control" required /><br>' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["url_fill_name"])); ?></label>' +
            '<input type="text" placeholder="<?php echo e(ucfirst($translations["backoffice"]["menus_placeholder_url"])); ?>" value="' + old_url + '" class="url form-control" required /> <br>' +
...
</script><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/menu_manager.blade.php ENDPATH**/ ?>