...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
	<div class="p-desktop-5">
		<div class="row">
			<div class="col-12">
				<h1><?php echo e(ucfirst($translations["backoffice"]["control_panel"])); ?></h1>
				<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
					<ol class="breadcrumb pt-0">
						<li class="breadcrumb-item">
							<a href="/adm"><?php echo e(ucfirst($translations["backoffice"]["store"])); ?></a>
						</li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo e(ucfirst($translations["backoffice"]["control_panel"])); ?></li>
					</ol>
				</nav>
			...
			<div class="col-lg-12 col-xl-6">
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/products" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["products"])); ?></p>
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/constructions" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["constructions"])); ?></p>
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/orders" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["orders"])); ?></p>
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/tickets" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["messages"])); ?></p>
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/clients" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["clients"])); ?></p>
                                    ...
                                    <div class="col-xs-3 col-md-3 mt-2">
                                        <a href="/adm/obituaries" class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-0"><?php echo e(ucfirst($translations["backoffice"]["obituaries"])); ?></p>
				...
				<div class="row">
					<div class="col-md-12 mb-4">
						<div class="card">
							<div class="card-body">
								<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["orders"])); ?></h5>
			...
			<div class="col-xl-6 col-lg-12 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/orders"><?php echo e(ucfirst($translations["backoffice"]["see_all_female"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_female"])); ?> <?php echo e($translations["backoffice"]["orders"]); ?></h5>
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-4 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/products"><?php echo e(ucfirst($translations["backoffice"]["see_all_male"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_male"])); ?> <?php echo e($translations["backoffice"]["products"]); ?></h5>
			...
			<div class="col-md-6 col-lg-4 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/tickets"><?php echo e(ucfirst($translations["backoffice"]["see_all_male"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_male"])); ?> <?php echo e($translations["backoffice"]["tickets"]); ?></h5>
			...
			<div class="col-md-12 col-sm-12 col-lg-4 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/clients"><?php echo e(ucfirst($translations["backoffice"]["see_all_male"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_male"])); ?> <?php echo e($translations["backoffice"]["clients"]); ?></h5>
		...
		<div class="row">
            ...
            <div class="col-lg-4 col-sm-12 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/constructions"><?php echo e(ucfirst($translations["backoffice"]["see_all_male"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_female"])); ?> <?php echo e($translations["backoffice"]["constructions"]); ?></h5>
			...
			<div class="col-lg-4 col-sm-12 mb-4">
				<div class="card dashboard-progress">
					...
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["highlighted_products"])); ?></h5>
			...
			<div class="col-lg-8 mb-4">
				<div class="card">
					<div class="position-absolute card-top-buttons">
						<a class="btn btn-outline-primary btn-xs" href="/adm/contacts"><?php echo e(ucfirst($translations["backoffice"]["see_all_male"])); ?></a> 
					</div>
					<div class="card-body">
						<h5 class="card-title"><?php echo e(ucfirst($translations["backoffice"]["latest_male"])); ?> <?php echo e($translations["backoffice"]["contact_requests"]); ?></h5>
					...
					<div class="card-body ">
						<div class="float-left float-none-xs">
							<div class="d-inline-block">
								<h5 class="d-inline"><?php echo e(ucfirst($translations["backoffice"]["views"])); ?></h5>
								<span class="text-muted text-small d-block"><?php echo e(ucfirst($translations["backoffice"]["unique_visitors"])); ?></span>
							</div>
						</div>
					</div>
...
init();
    ...
    function populateOrders(orders) {
                ...
                <div class="d-flex flex-row mb-3">
                    ...
                    <div class="pl-3 pt-2 pr-2 pb-2">
                        <a href="/adm/orders/show/` + item.id + `">
                            <p class="list-item-heading"><?php echo e(ucfirst($translations["backoffice"]["order"])); ?>: ` + item.order_number + `</p>
        ...
        if (orders === undefined || orders.length == 0) {
            ...
            $("#ordersList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_female"])); ?> <?php echo e($translations["backoffice"]["orders"]); ?></h4>
    ...
    function populateTickets(tickets) {
        ...
        $.each(tickets, function(key, item) {
            ...
            switch (item.status) {
                case "0":
                    ...
                    status = ' <span class="badge badge-pill tickets_pending"><?php echo e(ucfirst($translations["backoffice"]["ticket_pending"])); ?></span>';
                    break;

                case "1":
                    icon = '<i class="mr-1 simple-icon-check" style="font-size: 30px"></i>';
                    status = ' <span class="badge badge-pill tickets_close"><?php echo e(ucfirst($translations["backoffice"]["ticket_closed"])); ?></span>';
                    break;

                case "2":
                    icon = '<i class="mr-1 iconsmind-speach-bubble" style="font-size: 30px"></i>';
                    status = '<span class="badge badge-pill tickets_open"><?php echo e(ucfirst($translations["backoffice"]["ticket_open"])); ?></span>';
                    break;
            }
        ...
        if (tickets === undefined || tickets.length == 0) {
            ...
            $("#ticketsList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["tickets"]); ?></h4>
                <p class="text-muted"><?php echo e(ucfirst($translations["backoffice"]["try_again_later_empty"])); ?></p>
            `);
        }
    }
    ...
    function populateFeatured(products) {
        ...
        if (products === undefined || products.length == 0) {
            ...
            $("#featuredProductsList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["highlighted_products"]); ?></h4>
                <p class="text-muted"><?php echo e(ucfirst($translations["backoffice"]["try_again_later_empty"])); ?></p>
            `);
        }
    }
    ...
    function populateConstructions(constructions) {
        ...
        if (constructions === undefined || constructions.length == 0) {
            ...
            $("#constructionsList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["constructions"]); ?></h4>
                <p class="text-muted"><?php echo e(ucfirst($translations["backoffice"]["try_again_later_empty"])); ?></p>
            `);
        }
    }
    ...
    function populateClients(clients) {
        ...
        $.each(clients, function(key, item) {
            ...
            switch(item.isactive) {
                ...
                case "0":
                    ...
                    isactive = '<span class="dot red mr-2"></span><?php echo e(ucfirst($translations["backoffice"]["inactive"])); ?>';
                    break;

                case "1":
                    iconUser = '<i class="simple-icon-user-following iconsListIndex mr-2"></i>'
                    isactive =  '<span class="dot green mr-2"></span><?php echo e(ucfirst($translations["backoffice"]["active"])); ?>';
                    break;
            }
        ...
        if (clients === undefined || clients.length == 0) {
            ...
            $("#clientsList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["clients"]); ?></h4>
                <p class="text-muted"><?php echo e(ucfirst($translations["backoffice"]["try_again_later_empty"])); ?></p>
            `);
        }
    }
    ...
    function populateContacts(contacts) {
        ...
        $.each(contacts, function(key, item) {
            ...
            if (item.seen == "1") {
                ...
                seen = `<span class="badge badge-light text-uppercase text-bold w-100"><?php echo e(ucfirst($translations["backoffice"]["seen"])); ?></span>`;

            } else {

                seen = `<span class="badge badge-success text-uppercase text-bold w-100"><?php echo e(ucfirst($translations["backoffice"]["new"])); ?></span>`;
            }
        ...
        if (contacts === undefined || contacts.length == 0) {
            ...
            $("#contactsList").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["contact_requests"]); ?></h4>
                <p class="text-muted"><?php echo e(ucfirst($translations["backoffice"]["try_again_later_empty"])); ?></p>
            `);
        }
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/index.blade.php ENDPATH**/ ?>