    ...
    <main class="default-transition pt-5 mb-5 collapsable-main no-load">
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1><?php echo e(ucfirst($translations["backoffice"]["info_form_tilte"])); ?></h1>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo e(ucfirst($translations["backoffice"]["info_form_tilte"])); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead class="thead-light">
                                    <!--<tr>
                                        <th scope="col"></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["name"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["contact_subject"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["company"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["email"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["date"])); ?></th>
                                        <th scope="col"></th>
                                    </tr>-->

                                    <tr>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["booking_name"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["booking_email"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["booking_phone"])); ?></th>
                                        <th scope="col"><?php echo e(ucfirst($translations["backoffice"]["booking_description"])); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    $.confirm({
        ...
        theme: "supervan",
        content: '<?php echo e(ucfirst($translations["backoffice"]["confirm_message_remove_contact"])); ?>',
        buttons: {
        ...
        function populate(items) {
            ...
            $.each(items, function(key, item) {
                let message = item.description.slice(0, 30)+'...';
                let template = `
                    <tr class="text-muted" data-id="`+ item.id + `">
                        ...
                        <td>` + message + ` </td>             
                        <td>
                            <a href="javascript:void(0)" style="margin-left: 4px;" class="btn btn-xs btn-danger float-right remove-contacts"><?php echo e(ucfirst($translations["backoffice"]["contact_btn_remove"])); ?></a>
                           <a href="/adm/info-form/` + item.id + `"> <button  class="btn btn-outline-primary btn-xs float-right mr-2 ml-2" ><?php echo e(ucfirst($translations["backoffice"]["contact_btn_see"])); ?></button></a>
                        </td>
                    </tr>`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/info_form/index.blade.php ENDPATH**/ ?>