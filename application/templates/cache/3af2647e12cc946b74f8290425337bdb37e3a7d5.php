...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
    <div class="p-desktop-5">
        <div class="row">
            <div class="col-12">
                <div class="mb-3">
                    <h1><?php echo e(ucfirst($translations["backoffice"]["orders"])); ?></h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <?php echo e(ucfirst($translations["backoffice"]["orders"])); ?>
                ...
                <div class="mb-2">
                    <a class="btn pt-0 pl-0 d-inline-block d-md-none" data-toggle="collapse" href="#displayOptions" role="button" aria-expanded="true" aria-controls="displayOptions">
                        <?php echo e(ucfirst($translations["backoffice"]["view_options"])); ?>
                    ...
                    <div class="collapse d-md-block" id="displayOptions">
                        <div class="d-block d-md-inline-block">
                            <div class="btn-group float-md-left mr-1 mb-1">
                                <button class="btn btn-outline-dark btn-xs dropdown-toggle clients-order-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <?php echo e(ucfirst($translations["backoffice"]["order_by"])); ?>

                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item order-menu" data-order="id"><?php echo e(ucfirst($translations["backoffice"]["latest_added_female"])); ?></a>
                                    <a class="dropdown-item order-menu" data-order="pay_amount"><?php echo e(ucfirst($translations["backoffice"]["value"])); ?></a>
                                </div>
                            </div>
                        ...
                        <div class="float-md-right">
                            <span class="text-muted text-small mr-1"><?php echo e(ucfirst($translations["backoffice"]["listing"])); ?> </span>
    ...
    */
    ...
    function populate(items) {
        ...
        if (items === undefined || items.length == 0) {
            ...
            $(".list").html(`
                <h4><?php echo e(ucfirst($translations["backoffice"]["not_found_male"])); ?> <?php echo e($translations["backoffice"]["orders"]); ?></h4>
    ...
    function saveNewStatusHistoric(data, nameStatus) {
        ...
        $.confirm({
            ...
            theme: "supervan",
            content: '<?php echo e(ucfirst($translations["backoffice"]["confirm_change_order_status"])); ?>',
            buttons: {

                '<?php echo e(ucfirst($translations["backoffice"]["yes"])); ?>' : function () {
                ...
                '<?php echo e(ucfirst($translations["backoffice"]["no"])); ?>': {}
            }
        });
    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/orders/index.blade.php ENDPATH**/ ?>