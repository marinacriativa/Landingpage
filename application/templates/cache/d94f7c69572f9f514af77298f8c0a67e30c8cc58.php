<h4><?php echo e(ucfirst($translations["backoffice"]["design_title"])); ?></h4>
<hr>
<div id="design_settings">
    <div class="row mt-4">
        <div class="col-6 col-xl-3">
            <label><?php echo e(ucfirst($translations["backoffice"]["design_main_color"])); ?></label><br>
                <input style="margin-b" name="colors" data-config-name="colors" type="color" class="w-100"/>
        </div>
        <div class="col-6 col-xl-3">
            <label><?php echo e(ucfirst($translations["backoffice"]["design_header_color"])); ?></label><br>
            <input name="header_color" data-config-name="header_color" type="color" class="w-100"/>
        </div>
        <div class="col-6 col-xl-3">
            <label><?php echo e(ucfirst($translations["backoffice"]["design_footer_color"])); ?></label><br>
            <input name="footer_color" data-config-name="footer_color" type="color" class="w-100"/>
        </div>
        <div class="col-6 col-xl-3">
            <label><?php echo e(ucfirst($translations["backoffice"]["design_copyright_color"])); ?></label><br>
            <input name="copyright_color" data-config-name="copyright_color" type="color" class="w-100"/>
        </div>
        
    </div>
    <div class="w-100 mb-5 mt-3">
        <button type="button" class="btn btn-outline-primary btn-xs" data-settings="colors,header_color,footer_color,copyright_color"><?php echo e(ucfirst($translations["backoffice"]["design_btn_save"])); ?></button>
    </div>
    <div class="form-group mt-4 w-50">
        <label><?php echo e(ucfirst($translations["backoffice"]["design_logo"])); ?></label>
        <div id="logo-image"></div>
    </div>

    <div class="form-group mt-4 w-50">
        <label><?php echo e(ucfirst($translations["backoffice"]["design_footer_logo"])); ?></label>
        <div id="footer-image"></div>
    </div>

    <div class="form-group mt-4 w-10">
        <label><?php echo e(ucfirst($translations["backoffice"]["design_favicon"])); ?></label>
    ...
    function design() {
        ...
        $("#design_settings [data-settings]").on("click", function() {
            ...
            $.alert({
                ...
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations["backoffice"]["success_message_colors_save"])); ?>',
            });
        });
...
</script><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/design.blade.php ENDPATH**/ ?>