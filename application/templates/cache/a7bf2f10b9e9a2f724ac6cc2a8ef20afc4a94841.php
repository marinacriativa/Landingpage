    ...
    <main class="default-transition pt-5 mb-5 collapsable-main no-load">
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1><?php echo e(ucfirst($translations["backoffice"]["title_list_client"])); ?></h1>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo e(ucfirst($translations["backoffice"]["clients"])); ?>
                            ...
                            <div class="d-block d-md-inline-block">
                                <div class="btn-group float-md-left mr-1 mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item order-menu" data-order="email"><?php echo e(ucfirst($translations["backoffice"]["orderBy_email"])); ?></a>
            ...
            $.each(items, function (key, item) {
                ...
                switch(item.isactive){
                    case "0":
                        ...
                        isactive = '<span class="dot red mr-2"></span> <?php echo e(ucfirst($translations["backoffice"]["client_status_inactive"])); ?>';
                        break;
                    case "1":
                        iconUser = '<i class="simple-icon-user-following iconsListIndex mr-2"></i>'
                        isactive =  '<span class="dot green mr-2"></span> <?php echo e(ucfirst($translations["backoffice"]["client_status_active"])); ?>';
                        break;
                }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/clients/index.blade.php ENDPATH**/ ?>