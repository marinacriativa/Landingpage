...
<?php $__env->startSection('content'); ?>
    <main class="default-transition pt-5 mb-5 collapsable-main no-load">
        <div class="p-desktop-5">
            <div class="mb-3">
                <h1 class="inline"><?php echo e(ucfirst($translations['backoffice']['categories'])); ?></h1>
                <hr>
            ...
            function populateCategories(categories) {
                ...
                <li data-id="` + category.id + `" class='` + ((category.root == "1") ? "mb-5" : "pl-5") + ` ${element}'>
                    <div data-id="` + category.id + `" class='category-block'>
                        ...
                        ` + ((category.root == "1") ? "" :
                        "<a class='category-action edit'><i class='simple-icon-pencil float-right mr-3 mt-1'></i></a>"
                        ) + `
                        ` + ((category.root == "1") ? "" :
                        "<a class='category-action remove'><i class='simple-icon-close float-right mr-3 mt-1'></i></a>"
                        ) + `
                    </div>
                </li>
            `);
            ...
            function editCategory(id, old_name) {
                ...
                $.confirm({
                    ...
                    content: '' +
                        ...
                        '<div class="form-group">' +
                        '<label><?php echo e(ucfirst($translations['backoffice']['categories_fill_name'])); ?></label>' +
                        '<input type="text" placeholder="<?php echo e(ucfirst($translations['backoffice']['categories_placeholder_name'])); ?>" value="' +
                        old_name + '" class="name form-control" required />' +
                        '</div>' +
                        '</form>',
                    buttons: {
                        formSubmit: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/categories/categories_news.blade.php ENDPATH**/ ?>