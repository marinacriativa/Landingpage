<h4 class="inline"><?php echo e(ucfirst($translations["backoffice"]["customizeGroups_title"])); ?></h4>
<hr>
...
function personalizationGroups() {
    ...
    function addPersonalizationGroup(parent_id) {
        ...
        $.confirm({
            ...
            title: "<?php echo e(ucfirst($translations["backoffice"]["customizeGroups_create_title"])); ?>",
            theme: "supervan",
            content: '' +
            '<form action="" class="formName">' +
            '<div class="form-group">' +
            '<label><?php echo e(ucfirst($translations["backoffice"]["customizeGroups_fill_name"])); ?></label>' +
    ...
    function editPersonalizationGroup(id, old_name) {
        ...
        $.confirm({
            ...
            title: "<?php echo e(ucfirst($translations["backoffice"]["customizeGroups_edit_title"])); ?>",
            theme: "supervan",
            content: '' +
            '<form action="" class="formName">' +
            '<div class="form-group">' +
    ...
    function deletePersonalizationGroup(id) {
        ...
        $.confirm({
            ...
            theme: "supervan",
            content: '<?php echo e(ucfirst($translations["backoffice"]["confirm_message_remove_customizeGroups"])); ?>',
            buttons: {
...
</script><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/personalizationGroups.blade.php ENDPATH**/ ?>