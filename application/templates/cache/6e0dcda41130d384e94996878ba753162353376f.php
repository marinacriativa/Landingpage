<h4 class="inline"><?php echo e(ucfirst($translations["backoffice"]["methodPayment_title"])); ?></h4>
<hr>
<div class="table-responsive">
    <table id="thetable2" class="dt-responsive stripe languages-table dataTable no-footer dtr-inline" >
        <thead>
            <tr role="row">
                <th ><?php echo e(ucfirst($translations["backoffice"]["methodPayment_fill_name"])); ?></th>
                <th ><?php echo e(ucfirst($translations["backoffice"]["methodPayment_fill_status"])); ?></th>
                <th >#</th>
            </tr>
        </thead>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(ucfirst($translations["backoffice"]["methodPayment_settings"])); ?></h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-dismiss="modal"><?php echo e(ucfirst($translations["backoffice"]["methodPayment_btn_cancel"])); ?></button>
                <button type="button" class="btn btn-primary btn-save"><?php echo e(ucfirst($translations["backoffice"]["methodPayment_btn_save"])); ?></button>
            </div>
        </div>
    </div>
</div>
        ...
        $.ajax({
			...
			success: function(response) {
				...
				$.each(response.data, function(key, method) {
                    ...
                    let badge = (method.active == "1") ? '<span class="badge badge-pill badge-success method-active-button mb-1"><?php echo e(ucfirst($translations["backoffice"]["methodPayment_status_active"])); ?></span>' : '<span class="badge badge-pill badge-danger method-active-button mb-1">Desativado</span>';
	...
	function paymentMethodListners() {
		...
		$("body").on("click", '.method-active-button', function() {
			...
			if ($(this).hasClass("badge-success")) {
				...
				$(this).text("<?php echo e(ucfirst($translations["backoffice"]["methodPayment_status_inactive"])); ?>");
				...
				$(this).text("<?php echo e(ucfirst($translations["backoffice"]["methodPayment_status_active"])); ?>");
...
</script><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/config/items/payment.blade.php ENDPATH**/ ?>