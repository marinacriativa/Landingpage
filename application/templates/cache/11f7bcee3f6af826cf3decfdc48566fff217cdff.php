...
<body data-bgcolor="Body"
        ...
        <tr>
            ...
            <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row"
                    ...
                    data-module="colibri-preheader-18">
                    <!-- colibri-preheader-18 -->
                    <tr>
                        <td align="center" bgcolor="#fafafa" data-bgcolor="BgColor">
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr>
                                                <td class="rwd-col" align="center" width="46.66%"
                                                    style="width:46.66%;max-width:46.66%;">


                                                </td>
                                                <td class="rwd-col" align="center" width="6.66%" height="20"
                                                    style="width:6.66%;max-width:6.66%;height:20px;">&nbsp;</td>
                                                <td class="rwd-col" align="center" width="46.66%"
                                                    style="width:46.66%;max-width:46.66%;">
                                                    <!-- column -->
                                                    <!-- column -->
                                ...
                                <tr data-element="colibri-preheader-18-logo" data-label="Logo">
                                    <td height="30" style="font-size:30px;line-height:30px;"
                                        data-height="Spacing above logo">&nbsp;</td>
                                </tr>
                                <tr data-element="colibri-preheader-18-logo" data-label="Logo">
                                    <td align="center" class="center-text">
                                        ...
                                        <img style="width:200px;border:0px;display: inline!important;"
                                            src="<?php echo e(URL . $config->mail_logo); ?>" width="300" border="0" editable="true" data-icon
                                            data-image-edit data-url data-label="Logo" data-image-width alt="logo">
                                    </td>
                                </tr>
                                <tr>
        ...
        <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
            <td class="center-text" data-text-style="Paragraphs" align="center"
                ...
                <singleline>
                    ...
                    <?php echo e(ucfirst($translations["mail"]["footer_message"])); ?>

           <!--              (Esta mensagem é gerada de modo automático, por favor não responda a esta mensagem.</a>)  -->
                    <a href="<?php echo e($linkContact); ?>"><?php echo e(ucfirst($translations["mail"]["footer_message_contact"])); ?></a> .</span></em>
                    </div>
                </singleline>
            </td>
        </tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center"
                    ...
                    <tr>
                        <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Buttons"
                            data-bgcolor="Buttons" bgcolor="#E38529" style="border-radius: 36px;">
                            <!--[if (gte mso 9)|(IE)]>
        <table border="0" cellpadding="0" cellspacing="0" align="center">
          <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
        style="width:100%;max-width:100%;" data-module="colibri-footer">
        <!-- colibri-footer -->
        <tr>
            <td align="center">
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr data-element="colibri-footer-buttons" data-label="Buttons">
                        <td height="40" style="font-size:40px;line-height:40px;" data-height="Spacing under buttons">
                            &nbsp;</td>
                    </tr>

                    <tr data-element="colibri-footer-divider" data-label="Dividers">
                        <td height="26" data-height="Spacing bottom" data-border-color="Dividers"
                            style="border-bottom: 4px dotted #E4E4E4;font-size:26px;line-height:26px;">&nbsp;</td>
                    </tr>
                    <tr data-element="colibri-footer-divider" data-label="Dividers">
                        <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under divider">
                            &nbsp;</td>
                    </tr>

                    <!-- CRÉDITOS -->

                    <tr data-element="colibri-footer-paragraphs" data-label="Paragraphs">
                        <td align="center">
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                class="row" width="480" style="width:480px;max-width:480px;">
                                <tr>
                                    <td class="center-text" data-text-style="Paragraphs" align="center"
                                        style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:300;font-style:normal;color:#666666;text-decoration:none;letter-spacing:0px;">
                                        <multiline>
                                            <div mc:edit data-text-edit>

                                                <script>document.write(new Date().getFullYear())</script> CRIATIVATEK. All Rights Reserved.<br>
                    ...
                    <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                        
                        <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing under logo">&nbsp;
                        </td>
                    </tr>
                    <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                        <td align="center" class="center-text">
                            <img style="width:120px;border:0px;display: inline!important;" src="<?php echo e(URL . $config->mail_logo); ?>"
                                width="120" border="0" editable="true" data-icon data-image-edit data-url
                                data-label="Logo" data-image-width alt="logo">
                        </td>
                    </tr>
                    <tr>
                        <td height="60" style="font-size:60px;line-height:60px;" data-height="Footer spacing bottom">
                            &nbsp;</td>
                    </tr>
                </table>
                <!-- Content -->
...
<?php /**PATH /home/joferlis/public_html/application/templates/email/layouts/master.blade.php ENDPATH**/ ?>