		...
		<div class="row">
			<div class="col-md-12 mb-8">
                ...
                <div class="btn-group top-right-button-container">
                        <button type="button" href="#" onclick='javascript:window.location.assign("/adm/products");' class="btn btn-outline-secondary"><?php echo e(ucfirst($translations["backoffice"]["edit_custom_btn_back"])); ?></button>
                        <?php 
                            $countLangs = 0;
                        ?>
					...
					<h1><?php echo e(ucfirst($translations["backoffice"]["title_edit_product"])); ?></h1>
					<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
						<ol class="breadcrumb pt-0">
							<li class="breadcrumb-item"><a href="/adm"><?php echo e(ucfirst($translations["backoffice"]["store"])); ?></a></li>
							<li class="breadcrumb-item"><a href="/adm/products"><?php echo e(ucfirst($translations["backoffice"]["products"])); ?></a></li>
							<li class="breadcrumb-item active" aria-current="page"><?php echo e(ucfirst($translations["backoffice"]["title_edit_product"])); ?></li>
						</ol>
					</nav>
					...
					<div class="contact-form clearfix">
						<div class="row">
							<div class="col-md-12 col-xl-8 col-sm-12 col-xs-12 mb-3">
                                <div class="card">
									<div class="card-body">
                                        <h5 class="mb-3"><i class="simple-icon-grid mr-2"></i>Dados gerais</h5>
                                            <div class="row mt-5">
                                                <div class="col-12 col-lg-4"><label class="form-group has-float-label"> <input name="sku" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_ref"])); ?></span> </label> </div>
                                                <div class="col-12 col-lg-8"><label class="form-group has-float-label"> <input name="name" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_name"])); ?></span> </label> </div>
                                                ...
                                                <div class="col-12 col-lg-8"><label class="form-group has-float-label"> <input name="short_description" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["short_description"])); ?></span> </label> </div>
                                                <div class="col-12 col-lg-4 is-digital"><label class="form-group has-float-label"> <input name="gtin" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["gtin"])); ?></span> </label> </div>
                                                <div class="col-12 col-lg-4 is-digital"><label class="form-group has-float-label"> <input name="mpn" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["mpn"])); ?></span> </label> </div>
                                                <div class="col-12 col-lg-4 is-digital"><label class="form-group has-float-label"> <input name="main_brand" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["main_brand"])); ?></span> </label> </div>
                                            </div>
                                        </div>
                                    </div>
                                <br> 
									...
									<div class="card-body pt-0">
                                        <ul class="card-header pl-0 pb-0 nav nav-tabs step-anchor tproduto">
                                            <li class="nav-item active pr-2">
                                                <a id="first-tab" data-toggle="tab" href="#first" role="tab" class="nav-link active pl-0 font-weight-700" aria-controls="first" aria-selected="true"><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_description"])); ?> <br><small>Tab principal</small></a>
                                            </li>
                                            <li class="nav-item pr-2">
                                                <a data-toggle="tab" href="#second" role="tab" class="nav-link pl-0 font-weight-700" aria-controls="second" aria-selected="false"><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_others"])); ?> <br><small>Tab secundário</small></a>
                                            </li>
                                        </ul>
										<div class="row">
								...
								<div class="card">
									<div class="card-body">
                                    <h5 class="mb-3"><i class="simple-icon-grid mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_gallery"])); ?></h5>
								...
								<div class="card">
									<div class="card-body">
                                    <h5 class="mb-3"><i class="simple-icon-list mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes"])); ?></h5>
										...
										<div class="row mt-2">
											<div class="col-12 config-page">
												<table class="dt-responsive stripe languages-table dataTable no-footer dtr-inline" id="thetable" role="grid" style="width: 0px;">
													<thead class="thead">
														<tr>
                                                            <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 0px;" aria-sort="ascending" aria-label="Description: activate to sort column descending"><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_description"])); ?></th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 0px;" aria-label="Valor: activate to sort column ascending"><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_value"])); ?></th>
										...
										<div class="row mt-3">
											<div class="col-12">
												<div class="row">
													<div class="col-12 col-lg-6 mt-3"><label class="form-group has-float-label"> <input name="attribute_description" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_description"])); ?></span> </label> </div>
													<div class="col-12 col-lg-6 mt-3"><label class="form-group has-float-label"> <input name="attribute_value" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_value"])); ?></span> </label> </div>
												</div>                                    
                                                <button type="button" data-action="saveAttribute" class="btn btn-light default col-lg-12"><i class="simple-icon-plus mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_create"])); ?> </button> 
											</div>
										</div>
									</div>
								</div>
                                ...
                                <h5 class="mb-3"><i class="simple-icon-basket mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_type"])); ?></h5>
								<div class="card sw-main sw-theme-default">
									<div class="card-body pt-0">
                                        <ul class="card-header pl-0 pb-0 nav nav-tabs step-anchor tproduto">
                                            <li class="nav-item pr-2">
                                                <a data-type="0" data-toggle="tab" href="#productSimple" role="tab" class="nav-link type0 pl-0 font-weight-700 typeProduct" data-type="0" aria-controls="first" aria-selected="true"><?php echo e(ucfirst($translations["backoffice"]["edit_product_type_simple"])); ?> <br><small>Produto sem variates</small></a>
                                            </li>
                                            <li class="nav-item pr-2 is-digital">
                                                <a data-type="1" data-toggle="tab" href="#productComplex" role="tab" class="nav-link type1 pl-0 font-weight-700 typeProduct"  data-type="1" aria-controls="second" aria-selected="false"><?php echo e(ucfirst($translations["backoffice"]["edit_product_type_advanced"])); ?> <br><small>Produto com variantes</small></a>
                                            </li>
                                            <li class="nav-item pr-2 is-digital">
                                                <a data-type="2" data-toggle="tab" href="#customizedProduct" role="tab" class="nav-link type2 pl-0 font-weight-700 typeProduct" data-type="2" aria-controls="second" aria-selected="false"><?php echo e(ucfirst($translations["backoffice"]["edit_product_type_custom"])); ?> <br><small>À medida do cliente</small></a>
                                            </li>
                                        </ul>
											...
											<div class="col-12">
												<div class="tab-content mt-4">
													<div class="tab-pane fade type-pane0 mb-4" data-type="0" id="productSimple" role="tabpanel">
														<div class="row">
															<div class="col-12 col-lg-4 mt-3"><label class="form-group has-float-label"> <input data-name="stock" name="stock" type="number" autocomplete="off" min="0" max="9999999" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_simple_fill_stock"])); ?></span> </label> </div>
															<div class="col-12 col-lg-3 mt-3"><label class="form-group has-float-label"> <input data-name="price" name="price" type="number" autocomplete="off" min="0" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_simple_fill_current_price"])); ?></span> </label> </div>
															<div class="col-12 col-lg-3 mt-3"><label class="form-group has-float-label"> <input data-name="previous_price" name="previous_price" min="0" type="number" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_simple_fill_old_price"])); ?></span> </label> <span class="text-muted text-small"><?php echo e(ucfirst($translations["backoffice"]["product_simple_extra_info"])); ?></span> </div>
                                                            ...
                                                            <div class="col-12 col-lg-3 mt-3"><label class="form-group has-float-label"> <input data-name="iva" name="iva" min="0" type="number" autocomplete="off" class="form-control"> <span>IVA</span> </label> <span class="text-muted text-small"><?php echo e(ucfirst($translations["backoffice"]["product_simple_extra_info"])); ?></span>  </div>
                                                        </div>
													</div>
													<div class="tab-pane fade type-pane1" id="productComplex" role="tabpanel">
															...
															<table class="dt-responsive stripe languages-table dataTable no-footer dtr-inline" id="thetable" role="grid" style="width: 0px;">
																<thead class="thead">
																	<tr>
                                                                        ...
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 0px;" aria-label="Description: activate to sort column ascending"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_description"])); ?></th>
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 0px;" aria-label="Valor: activate to sort column ascending"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_stock"])); ?></th>
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 0px;" aria-label="Valor: activate to sort column ascending"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_price"])); ?></th>
														...
														<button class="btn btn-light default col-lg-12 mt-4 openModal" type="button"><i class="simple-icon-plus mr-2"></i> <?php echo e(ucfirst($translations["backoffice"]["product_advanced_new"])); ?> </button> 
													</div>
													<div class="tab-pane fade type-pane2" data-type="2" id="customizedProduct" role="tabpanel">
														<div class="col-12">
															<div class="row">
															<div class="col-12 col-lg-5 mt-3"><label class="form-group has-float-label"> <input data-name="stock" name="stock" type="number" autocomplete="off" min="0" max="9999999" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_custom_fill_stock"])); ?></span> </label> </div>
															<div class="col-12 col-lg-5 mt-3"><label class="form-group has-float-label"> <input data-name="price" name="price" type="number" autocomplete="off" min="0" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_custom_fill_price"])); ?></span> </label> </div>
                                                            <div class="col-12 col-lg-2 mt-3">
                                                                <span class="custom-switch custom-switch-secondary custom-switch-small vertical-align-center"> 
                                                            ...
                                                            <div class="col-12 col-lg-3 mt-3"><label class="form-group has-float-label"> <input data-name="iva" name="iva" min="0" type="number" autocomplete="off" class="form-control"> <span>IVA</span> </label> </div>
                                                        </div>
														</div>
								...
								<div class="card d-none">
									<div class="card-body">
										<h5><i class="simple-icon-list mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts"])); ?></h5>
										<hr>
										<div class="row mt-2">
											<div class="col-12">
												<table class="table table-hover">
													<thead class="thead">
														<tr>
															<th class="text-center" scope="col"><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts_qty"])); ?></th>
															<th class="text-center" scope="col"><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts_value"])); ?></th>
															<th scope="col"></th>
														</tr>
													</thead>
										...
										<div class="row mt-3">
											<div class="col-12">
												<div class="row">
													<div class="col-12 col-lg-6 mt-3"><label class="form-group has-float-label"> <input name="discount_quantity" type="number" autocomplete="off" min="1" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts_qty"])); ?></span> </label> </div>
													<div class="col-12 col-lg-6 mt-3"><label class="form-group has-float-label"> <input name="discount_percentage" type="number" autocomplete="off" min="1" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts_value"])); ?></span> </label> </div>
												</div>
												<button class="btn btn-light col-lg-12 " type="button" data-action="saveDiscount"><i class="simple-icon-plus mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_discounts_new"])); ?> </button> 
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										<div class="w-100">
											<h5><i class="simple-icon-organization mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["edit_product_seo_tags"])); ?></h5>
											<hr>
											<div class="form-group mt-4"><label class="form-group has-float-label"> <input name="slug" type="text" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_url_friendly"])); ?></span> </label> </div>
											<div class="form-group mt-4"><label class="form-group has-float-label"> <input type="text" name="keywords" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["edit_product_fill_tags"])); ?></span> </label> </div>
											<div class="row mt-2">
													...
													<div class="widget-body">
														<div class="seo-preview">
															...
															<div class="page-url-seo ws-nm">
																<p><?php echo e(URL); ?><?php echo e($selected_language->code); ?>/products/<span data-fill="slug"></span></p>
															</div>
							...
							<div class="col-md-12 col-xl-4 col-sm-12 col-xs-12">
										...
										<div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <button type="button" data-action="save" class=" btn btn-outline-info btn-xs mt-2 mr-2"><?php echo e(ucfirst($translations["backoffice"]["edit_product_btn_save"])); ?></button> 
                                                    <a class="btn btn-outline-success btn-xs mt-2 mr-2" href="/api/filters/cron" target="_blank">Atualizar Filtros</a> 
                                                </div>
                                                <div class="col-4">
                                                    <div class="row">
                                                        <div class="col-7 mt-2 p-0">
                                                            <span class="">Destacar:</span>
                                                        </div>    
                                                        <div class="col-5 p-0">
                                                            <div class="custom-switch custom-switch-secondary custom-switch-small vertical-align-bottom mt-1">
                                                                
                                                                <input class="custom-switch-input" id="featuredSwitch" type="checkbox">
                                                                <label rel="tooltip" title="Destacar" class="custom-switch-btn" for="featuredSwitch"></label> 
                                                            </div>
                                                        </div> 
                                                    </div> 
                                                </div>
                                            </div>                                            
                                            <?php if(MODULES_PRODUCT_CONDITION): ?>
                                                <div class="form-group mt-4">
                                                    <label><span class="dot green mr-2"></span> <?php echo e(ucfirst($translations["backoffice"]["edit_product_status"])); ?></label> 
                                                    <select name="product_condition" class="form-control">
                                                        <option value="0"><?php echo e(ucfirst($translations["backoffice"]["product_status_new"])); ?></option>
                                                        <option value="1"><?php echo e(ucfirst($translations["backoffice"]["product_status_used"])); ?></option>
                                                        <option value="2"><?php echo e(ucfirst($translations["backoffice"]["product_status_semi_new"])); ?></option>
                                                        <option value="3"><?php echo e(ucfirst($translations["backoffice"]["product_status_other"])); ?></option>
                                                    </select>
                                                </div>
                                            <?php endif; ?>
                                                <div class="form-group mt-4">
										...
										<div class="card-body">
											...
											<div class="w-100">
                                                ...
                                                <div class="input-group mb-3 is-digital">
                                                    <label class="form-group has-float-label"> <input type="text" name="labels" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["edit_products_fill_badges"])); ?></span></label>
											    ...
											    <div class="input-group mb-3 is-digital">
                                                    <label class="form-group has-float-label"> <input placeholder="https://youtube.com/watch?v=dQw4w9WgXcQ" name="youtube" type="text" autocomplete="off" class="form-control"><span><?php echo e(ucfirst($translations["backoffice"]["edit_products_youtube"])); ?></span> </label>
                                                    <div class="input-group-text p-0 pl-1 pr-1">
                                                        <span class="custom-switch custom-switch-secondary custom-switch-small vertical-align-center"> 
                                                ...
                                                <div class="form-group mt-4"> <label class="form-group has-float-label"> <input type="text" name="order_by" class="form-control"> <span>Nº ordenação</span> </label> </div>
                                            </div>
										</div>
									</div>
								</div>
                                ...
                                <?php if(MODULES_FILTERS): ?>
                                    <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="card">
                                            <div class="col-12">
                                                <div class="card-body">
                                                    <h5><i class="simple-icon-list mr-2"></i><?php echo e($filter->name); ?></h5>
                                                    <hr>
                                                        ...
                                                        <ul class='p-0 cat-element'>
                                                            <?php $__currentLoopData = $filter->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>     
                                                                ...
                                                                <li class='mb-1' style="min-width: 100%">
                                                                    <div data-id="<?php echo e($item->id); ?>" class='category-block'>
                                                                        <input <?php echo e($is_checked); ?> class="mt-2 mr-2 ml-2" type="checkbox"><?php echo e($item->name); ?>
								...
								<div class="card">
									<div class="col-12">
										<div class="card-body">
											<h5><i class="simple-icon-list mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["categories"])); ?></h5>
											<hr>
                                ...
                                <div class="card">
									<div class="col-12">
										<div class="card-body">
											<h5><i class="simple-icon-list mr-2"></i><?php echo e(ucfirst($translations["backoffice"]["brands"])); ?></h5>
											<hr>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header" style="flex: 0">
				<h5 class="modal-title"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_new_title"])); ?></h5>
			...
			<div class="modal-body">
				<div id="infoAdvancedProduct">
					<div class="row">
						...
						<div class="col-12 col-xl-12 mt-3 block"><label class="form-group has-float-label"> <input name="advanced_name" type="text" placeholder="XL, branco, etc" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_description"])); ?></span> </label></div>
					</div>
					<div class="row">
						<div class="col-12 col-xl-3 mt-3 block"><label class="form-group has-float-label"> <input name="advanced_stock" type="number" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_stock"])); ?></span> </label> </div>
						<div class="col-12 col-xl-6 mt-3 block"><label class="form-group has-float-label"> <input name="advanced_current_price" type="number" autocomplete="off" class="form-control"> <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_price"])); ?></span> </label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-3 mt-3"><label class="form-group has-float-label"> <input data-name="advanced_iva" name="advanced_iva" min="0" type="number" autocomplete="off" class="form-control"> <span>IVA</span> </label> </div>
                    </div>
                    <hr>
			...
			<div class="modal-footer"> <button type="button" class="btn btn-outline-primary" data-dismiss="modal"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_new_btn_close"])); ?></button> <button type="button" class="btn btn-primary" data-dismiss="modal" data-action="saveAdvancedProduct"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_new_btn_save"])); ?> </button> </div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" role="attribute">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_edit"])); ?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button> 
			</div>
			<div class="modal-body">
				<div>                
                    <div class="row">
						<div class="col-12 mt-3 block"><label class="form-group has-float-label"> <input name="describe_attr" type="text" autocomplete="off" class="form-control"> <span>Descrição</span> </label> </div>
					</div>
			...
			<div class="modal-footer"> <button type="button" class="btn btn-outline-primary" data-dismiss="modal"><?php echo e(ucfirst($translations["backoffice"]["product_advanced_new_btn_close"])); ?></button> <button type="button" class="btn btn-primary" data-dismiss="modal" data-action="editAttribute"><?php echo e(ucfirst($translations["backoffice"]["edit_product_attributes_edit"])); ?> </button> </div>
		</div>
	</div>
</div>
  ...
  <script>
        ...
        function getPageData() {
            ...
            if (type == "0") {
                ...
                data["iva"]             = $("#productSimple [data-name='iva']").val();
                ...
                data["iva"]             = $("#customizedProduct [data-name='iva']").val();
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-12 mt-3 block">
                                <label class="form-group has-float-label">
                                    ...
                                    <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_description"])); ?></span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-xl-6 mt-3 block">
                                <label class="form-group has-float-label">
                                    ...
                                    <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_stock"])); ?></span>
                                </label>
                            </div>
                            <div class="col-12 col-xl-6 mt-3 block">
                                <label class="form-group has-float-label">
                                    ...
                                    <span><?php echo e(ucfirst($translations["backoffice"]["product_advanced_fill_price"])); ?> atual</span>
                                </label>
                            </div>

                            <div class="col-12 col-xl-6 mt-3 block">
                                <label class="form-group has-float-label">
                                    <input name="advanced_iva" type="number"
                                           autocomplete="off"
                                           class="form-control" value="` + response.data.iva + `">
                                    <span>IVA</span>
                                </label>
                            </div>
        ...
        function languages(related, select_language) {
            ...
            $.each(active, function (key, lang) {
                ...
                if (lang.item_id == null) {
                    ...
                    button = `<a href="javascript:void(0)" style="min-width: 80px" class="btn btn-success btn-xs float-right"><?php echo e(ucfirst($translations["backoffice"]["language_btn_current"])); ?></a>`;
                    $(".language-selected").append(`
                        ` + lang.name + `
                    `);
                } else {
                    button = `<a href="/adm/products/` + lang.item_id + `" style="min-width: 80px" class="btn btn-info btn-xs float-right"><?php echo e(ucfirst($translations["backoffice"]["language_btn_see"])); ?></a>`;
                }
            ...
            $.each(non_active, function (key, lang) {
                $(".languages-list").append(`
                        <tr>
                            ...
                            <td></td>
                            <td><a href="javascript:void(0)" data-lang="` + lang.code + `" data-lang-name="` + lang.name + `" style="min-width: 80px" class="btn btn-light btn-xs float-right create-other-language-button"><?php echo e(ucfirst($translations["backoffice"]["language_btn_create"])); ?></a></td>
                        </tr>
                    `);
            });
        }
        ...
        function createAnotherLanguage(lang, name) {
            ...
            $.confirm({
                title: name,
                theme: "supervan",
                content: '<?php echo e(ucfirst($translations["backoffice"]["language_btn_see"])); ?>' ,
                buttons: {
                    Sim: function () {
                        $.ajax({
                            url: "/api/products/",
        ...
        function imageEditor(image) {
            ...
            $('.tui-image-editor-header-buttons .tui-image-editor-download-btn').replaceWith('<button style="background-color: #fff; border: 1px solid #ddd; color: #222;" class="tui-image-editor-save-btn" ><?php echo e(ucfirst($translations["backoffice"]["editor_image_save"])); ?></button>');
            $('.tui-image-editor-header-buttons').children().first().replaceWith('<button class="tui-image-editor-close-btn" ><?php echo e(ucfirst($translations["backoffice"]["editor_image_cancel"])); ?></button>');
            ...
            $(".dropzone").dropzone({
                ...
                transformFile: function(file, done) {
                    if(file.type == "image/webp") {
                        alert('Formato webp imagem não permitido.')
                        return false;
                    }
                ...
                removedfile: function (file) {
                    ...
                    $.confirm({
                        title: '<?php echo e(ucfirst($translations["backoffice"]["confirm"])); ?>',
                        content: '<?php echo e(ucfirst($translations["backoffice"]["confirm_delete_file"])); ?>',
                        theme: 'supervan',
                        buttons: {
                            yes: {
                                keys: ['enter'],
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\CRIATIVA\application\templates\backoffice/pages/products/page.blade.php ENDPATH**/ ?>