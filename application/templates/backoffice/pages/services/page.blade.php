	...
	<div class="p-desktop-5">
		<div class="row">
			<div class="col-md-12 mb-8">
				<div class="col-12">
					<h1>{{ ucfirst($translations["backoffice"]["title_edit_services"]) }}</h1>
                    
					<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
						<ol class="breadcrumb pt-0">
							<li class="breadcrumb-item"><a href="/adm">{{ ucfirst($translations["backoffice"]["store"]) }}</a></li>
							<li class="breadcrumb-item"><a href="/adm/services">{{ ucfirst($translations["backoffice"]["services"]) }}</a></li>
							<li class="breadcrumb-item active" aria-current="page">{{ ucfirst($translations["backoffice"]["title_edit_services"]) }}</li>
						</ol>
					</nav>
                    <div class="btn-group top-right-button-container">
                        <button type="button" href="javascript:void(0)" onclick='javascript:window.location.assign("/adm/services");' class="btn btn-outline-secondary">{{ ucfirst($translations["backoffice"]["edit_custom_btn_back"]) }}</button>
                        @php 
                            $countLangs = 0;
                        @endphp
							...
							<div class="col-md-12 col-xl-8 col-sm-12 col-xs-12 mb-3">
								<div class="card">
									<div class="card-body">
										...
										<hr>
                                        <div class="row">                                         
                                                <div class="form-group mt-4 col-6"><label class="form-group has-float-label"> <input name="title" id="title_x" type="text" autocomplete="off" class="form-control"> <span>{{ ucfirst($translations["backoffice"]["services_title"]) }}</span> </label> </div>
                                                <div class="form-group mt-4 col-6"><label class="form-group has-float-label"> <input name="slug" id="slug_x" type="text" autocomplete="off" class="form-control"> <span>{{ ucfirst($translations["backoffice"]["edit_product_fill_url_friendly"]) }}</span> </label> </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-4">
                                                <h5>{{ ucfirst($translations["backoffice"]["services_logo"]) }}</h5>
                                                <hr>
                                                <div id="photo"></div>
                                            </div>
                                            <div class="col-4">
                                                <h5>{{ ucfirst($translations["backoffice"]["services_index"]) }}</h5>
                                                <hr>
                                                <div id="front"></div>                                                
                                            </div>
                                            <div class="col-4">
                                                <h5>{{ ucfirst($translations["backoffice"]["services_banner"]) }}</h5>
                                                <hr>
                                                <div id="banner"></div>                                                
                                            </div>
                                        </div>                                        
										<div class="row mt-5">
<!-- 											<div class="col-12 col-lg-4"><label class="form-group has-float-label"> <input name="photo" id="photo_x" type="file" autocomplete="off" class="form-control" accept="image/*"> <span>{{ ucfirst($translations["backoffice"]["services_logo"]) }}</span> </label> </div>
											<div class="col-12 col-lg-8"><label class="form-group has-float-label"> <input name="banner" id="banner_x" type="file" autocomplete="off" class="form-control" accept="image/*"> <span>{{ ucfirst($translations["backoffice"]["services_banner"]) }}</span> </label> </div> -->
							...
							<div class="col-md-12 col-xl-4 col-sm-12 col-xs-12">
								...
								<div class="card">
									<div class="col-12">
										<div class="card-body">
											<div class="w-100">
												<h5><i class="simple-icon-tag mr-2"></i>{{ ucfirst($translations["backoffice"]["edit_products_badges"]) }}</h5>
												<hr>
								...
								<div class="card">
									<div class="col-12">
										<div class="card-body">
											<h5><i class="simple-icon-control-play mr-2"></i>{{ ucfirst($translations["backoffice"]["edit_products_youtube"]) }}</h5>
											<hr>
											<div class="form-group mt-4"><label class="form-group has-float-label"> <input placeholder="https://youtube.com/watch?v=dQw4w9WgXcQ" name="youtube" type="text" autocomplete="off" class="form-control"> </label> </div>
										</div>
									</div>
								</div>
								 <br> 
								<div class="card">
									<div class="col-12">
										<div class="card-body">
											<h5><i class="simple-icon-globe-alt mr-2"></i>{{ ucfirst($translations["backoffice"]["languages"]) }}</h5>
											<hr>
											<table class="table table-hover borderless">
												<tbody class="languages-list"></tbody>
											</table>
...
@section('scripts')
    ...
    <script>
        ...
        function init() {
            ...
            var page = new RegExp('^/adm/services/.*');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function (key, value) {
                        ...
                        if(response.data.photo == null && response.data.banner == null) {
                        ...
                        switch (key) {
                            ...
                            case "front":
                                ...
                                if (value != null && value.length > 0) {
                                    // Carregar imagem do slide
                                    $("#front").slim('load',  value, { blockPush : true }, function(error, data) { });
                                }
                                break;
                            ...
                            case "banner":
                                ...
                                if (value != null && value.length > 0) {
                                    // Carregar imagem do slide
                                    $("#banner").slim('load',  value, { blockPush : true }, function(error, data) { });
                                }
                                break;
                            ...
                            /* case "photo":
                                ...
                                // }
                                document.querySelector('#preview_photo').innerHTML = `<img src="`+ value +`" width="150"/>`;
                                break;
                            ...
                            case "banner":
                                ...
                                //     $(".slim").slim('load',  value, { blockPush : true }, function(error, data) { });
                                // }
                                document.querySelector('#preview_banner').innerHTML = `<img src="`+ value +`" width="150"/>`;
                                break; */
        ...
        function getPageData() {
            ...
            let slim_front = $("#front").slim('data')[0];
            let slim_banner = $("#banner").slim('data')[0];
           
            if (slim_photo.server) {
                
                data.photo = slim_photo.server;
            }
            if (slim_front.server) {
                
                data.front = slim_front.server;
            }
            if (slim_banner.server) {
                
                data.banner = slim_banner.server;
            }
