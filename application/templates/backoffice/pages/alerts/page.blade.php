        ...
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-md-12 mb-8">
                    <div class="col-12">
                        <h1 id="title-client">{{ ucfirst($translations["backoffice"]["title_edit_alert"]) }}</h1>
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/adm/alerts">{{ ucfirst($translations["backoffice"]["title_alerts"]) }}</a>
                                </li>
                                <li class="breadcrumb-item active" id="breadcrumb_client" aria-current="page">{{ ucfirst($translations["backoffice"]["title_edit_alert"]) }}
                                </li>
                            </ol>
                        </nav>
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                               ...
                                               <!--  <div class="form-group col-6 text-right">
                                                    <label>Ativo</label> 
                                                    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small"> <input class="custom-switch-input" id="featuredSwitch" type="checkbox"> <label rel="tooltip" title="Mostrar no cabeçalho" class="custom-switch-btn" for="featuredSwitch"></label> </div>
                                                </div> -->
                                            </div>
                                            ...
                                            <div class="row">                                               
                                                <div class="col-6">                                                    
                                                    <label class="form-group has-float-label">
                                                        ...
                                                        <span>{{ ucfirst($translations["backoffice"]["alerts_title"]) }}</span>
                                                    </label>                                                    
                                                </div>  
                                                <div class="col-6">                                                    
                                                    <label class="form-group has-float-label">
                                                        <input name="link" id="link_alert" type="text"
                                                            autocomplete="off" class="form-control">
                                                        <span>{{ ucfirst($translations["backoffice"]["alerts_link"]) }}</span>
                                                    </label>                                                    
                                                </div>  
                                                <div class="col-12">                                                    
                                                    <label class="form-group has-float-label">
                                ...
                                <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12" id="clientsCardsStatusActions">
                                    <div class="card">
                                        <div class="col-12">
                                            <div class="card-body">
                                                <a href="javascript:void(0)" onclick='javascript:window.location.assign("/adm/alerts");' class="btn btn-xs btn-outline-secondary m-1">{{ ucfirst($translations["backoffice"]["edit_custom_btn_back"]) }}</a>
                                                <button type="button" data-action="deletePage" class="btn btn-outline-danger btn-xs m-1 ">{{ ucfirst($translations["backoffice"]["edit_client_btn_remove"]) }}
                                                </button>
                                                <button type="button" data-action="savePage" class="btn btn-outline-info btn-xs m-1 btn-save-client">{{ ucfirst($translations["backoffice"]["edit_client_btn_save"]) }}
                                                </button>    
...
<script type="text/javascript" >
        ...
        function init() {
            var page = new RegExp('^/adm/alerts/.*');
                    ...
                    Sim: function () {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.replace("/adm/alerts/");
