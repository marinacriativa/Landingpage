                    ...
                    <div class="col-12">
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/adm/cycles_blocks">{{ ucfirst($translations["backoffice"]["title_cycles_blocks"]) }}</a>
                                </li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">                                               
                                                <div class="col-6">                                                    
                                                    <label class="form-group has-float-label">
                                                        ...
                                                        <span>{{ ucfirst($translations["backoffice"]["title"]) }}</span>
                                                    </label>                                                    
                                                </div>  
                                                <div class="col-6">                                                    
                                                    <label class="form-group has-float-label">
                                            ...
                                            <div class="row">
                                                <div class="col-12">                                                    
                                                    <label class="form-group has-float-label">
                                                        <input name="icon" id="link_alert" type="text"
                                                            autocomplete="off" class="form-control">
                                                        <span>{{ ucfirst($translations["backoffice"]["blocks_icon"]) }}</span>
                                                    </label>                                                    
                                                </div>  
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12" id="clientsCardsStatusActions">
                                    <div class="card">
                                        <div class="col-12">
                                            <div class="card-body">
                                                <a href="javascript:void(0)" onclick='javascript:window.location.assign("/adm/cycles_blocks");' class="btn btn-xs btn-outline-secondary m-1">{{ ucfirst($translations["backoffice"]["edit_custom_btn_back"]) }}</a>
...
<script type="text/javascript" >
        ...
        function init() {
            var page = new RegExp('^/adm/cycles_blocks/.*');
