    ...
    <main class="default-transition pt-5 mb-5 collapsable-main no-load">
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1>{{ ucfirst($translations["backoffice"]["filters"]) }}</h1>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ ucfirst($translations["backoffice"]["filters"]) }}
                                </li>
                            </ol>
                        </nav>
                    </div>
...
{{--                                    class="simple-icon-arrow-down align-middle"></i></a>--}}
                        <div class="collapse d-md-block" id="displayOptions">
                            ...
                            <div class="float-md-right">
                                <a class="btn btn-success btn-sm mr-2" href="/api/filters/cron" target="_blank">Atualizar Filtros no Website</a> 
...
@section('scripts')
    <script>
        ...
        function load() {
            ...
            window.history.replaceState("", "", '/adm/filters?' + $.param( { limit: limit, order: order, page: page, search: search } ));
        ...
        function populate(items) {
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                                ...
                                <div class="w-40 w-sm-100 m-1">
                                    <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right" name="delte_slide_btn " title="apagar" id="delte_slide_btn" onclick="removeFilter(` + item.id + `)"><i class="simple-icon-trash"></i></button>
                                    <a class="btn btn-outline-secondary mb-1 btn-xs m-1 float-right" name="edit_slide_btn" title="editar" id="edit_slide_btn" href="/adm/filters/` + item.id + `"><i class="simple-icon-pencil"></i></a>
            ...
            if (items === undefined || items.length == 0) {
                ...
                $(".list").html(`
                	<h4>{{ ucfirst($translations["backoffice"]["not_found_male"]) }} {{ $translations["backoffice"]["filters"] }}</h4>
