	<h4 class="w-100">{{ ucfirst($translations["backoffice"]["banner_title"]) }}
	<a href="#" class="btn btn-xs btn-outline-primary float-right add-new-banners">{{ ucfirst($translations["backoffice"]["banner_btn_create"]) }}</a>
</h4>
<hr>
<div class="row mt-2">
    <div class="col-12">
		...
		<div class="modal-content">
			...
			<form>
					...
					<div class="form-group mt-3">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_title"]) }}</label>
						<input name="title" class="form-control">
					</div>
					<div class="form-group">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_subTitle"]) }}</label>
						<input name="subtitle" class="form-control">
					</div>
					<div class="form-group">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_description"]) }}</label>
						<input name="description" class="form-control">
					</div>
					<div class="form-group">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_btn_text"]) }}</label>
						<input name="button_text" class="form-control">
					</div>
					<div class="form-group">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_url"]) }}</label>
						<input name="link" class="form-control">
					</div>
					<div class="form-group">
						<label>{{ ucfirst($translations["backoffice"]["banner_fill_language"]) }}</label>
