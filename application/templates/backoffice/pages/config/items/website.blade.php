<h4>{{ ucfirst($translations["backoffice"]["settings_title"]) }}
...
<div class="form-group mt-2">
    <div class="custom-switch custom-switch-secondary mb-2 custom-switch-small">
        <label>{{ ucfirst($translations["backoffice"]["store_settings_btn_maintenance"]) }}</label>
...
<div class="row">
    <div class="col-12 mt-4">
        <button type="button" class="btn btn-outline-primary btn-xs float-right save-store-settings">{{ ucfirst($translations["backoffice"]["store_settings_btn_save"]) }}</button>
    </div>
</div>
                        ...
                        $("#store-languages-tabs").append(`
                            <div class="tab-pane fade ` + ((language.default === "1") ? "active show" : "") +
                                ...
                                <div class="form-group mt-4 has-float-label">
                                    <label>{{ ucfirst($translations["backoffice"]["store_settings_fill_title"]) }}</label>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 col-xl-4 has-float-label">
                                        <label class="ml-3">{{ ucfirst($translations["backoffice"]["store_fill_main_email"]) }}</label>
                                    ...
                                    <div class="col-12 col-xl-4 mt-xl-0 mt-4 has-float-label">
                                        <label class="ml-3">{{ ucfirst($translations["backoffice"]["store_settings_fill_phone"]) }}</label>
                                    ...
                                    <div class="col-12 col-xl-4 mt-xl-0 mt-4 has-float-label">
                                        <label class="ml-3">{{ ucfirst($translations["backoffice"]["store_settings_fill_address"]) }}</label>
                                ...
                                <div class="form-group mt-4 has-float-label">
                                    <label>{{ ucfirst($translations["backoffice"]["store_settings_fill_text_copyright"]) }}</label>
                                    <input name="copyright" data-multi-lang-config-name="copyright" data-language="` + language.code + `" type="text" class="form-control"/>
                                </div>
                                <div class="form-group mt-4 has-float-label">
                                    <label>{{ ucfirst($translations["backoffice"]["store_settings_fill_text_footer"]) }}</label>
                                ...
                                <div class="form-group mt-3 has-float-label">
                                    <label>{{ ucfirst($translations["backoffice"]["store_settings_fill_text_maintenance"]) }}</label>
