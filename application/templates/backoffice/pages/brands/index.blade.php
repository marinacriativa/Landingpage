                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form>
                                ...
                                <label class="form-group has-float-label" id="group_ipt"> 
    ...
    <script>   
                    ...
                    Sim: function () {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                window.location.replace("/adm/brands/");
                            },
        ...
        function brands() {
            ...
            function initBrands() {
                ...
                $("#slimBrand").slim(slimDefaultConfig( { folder: 'brands' } ));

                window.history.replaceState("", "", '/adm/brands?' + $.param( { limit: limit, order: order, page: page, search: search } ));                    

                $.ajax({
                    url: "/api/brands?page=" + page + "&search=" + search + "&limit=" + limit + "&order=" + order,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
                        ...
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div class="card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center">
                                <a href="javascript:void(0)" class="w-40 w-sm-100 truncate edit-brands" data-id="` + brands.id + `">
                                    <p class="list-item-heading mb-0 truncate">` + brands.name + `</p>
                                </a>
                                <p class="mb-0 text-muted text-small w-10 w-sm-100 m-1 truncate">` + brands.description + `</p>
                                <div class="w-40 w-sm-100 ">
                                    ...
                                    <span class="custom-switch custom-switch-secondary mb-2 custom-switch-small vertical-align-center"> 
                                        <input class="custom-switch-input change_active_status" data-id="` + brands.id + `" id="brand-active-` + brands.id + `" type="checkbox" name="active" ${is_checked}> 
                                        <label rel="tooltip" title="Desativado / Ativado" class="custom-switch-btn" for="brand-active-` + brands.id + `"></label> 
                                    </span>
            ...
            function listenersbrands() {               
                ...
                $(".edit-brands").on("click", function() {
                    ...
                    // Alterar o titulo do modal
                    $("#big-brands-modal h3").text("Editar coupon");
                    ...
                    $.get("/api/brands/" + id, function(response) {
