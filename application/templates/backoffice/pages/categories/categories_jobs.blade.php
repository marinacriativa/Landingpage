...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
    <div class="p-desktop-5">
        <div class="mb-3">
            ...
            <hr>
            <div id="categories_jobs" class="container card p-4 general_items">
    ...
    function categoriesInit() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#categories_jobs").html(populateCategories(categories));
            ...
            let category_template = $(`
                <li data-id="` + category.id + `" class='` + ((category.root == "1") ? "mb-5" : "pl-5") + ` ${element}'>
                    <div data-id="` + category.id + `" class='category-block'>
                        ...
                        ` + ((category.root == "1") ? "<a class='category-action add'><i class='simple-icon-plus float-right mr-3 mt-1'></i></a>" : "") + `
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            url: "/api/categories_jobs/" + id + "?name=" + name,
                            type: "PUT",
                            dataType: "json",
                            success: function (response) {
