...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
    <div class="p-desktop-5">
        <div class="mb-3">
            ...
            <hr>
            <div id="categories_news" class="container card p-4 general_items">
    ...
    function categoriesInit() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#categories_news").html(populateCategories(categories));
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            url: "/api/categories_news/" + id + "?name=" + name,
                            type: "PUT",
                            dataType: "json",
                            success: function (response) {
