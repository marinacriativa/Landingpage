...
<main class="default-transition pt-5 mb-5 collapsable-main no-load">
    <div class="p-desktop-5">
        <div class="mb-3">
            ...
            <hr>
            <div id="categories_constructions" class="container card p-4 general_items">
    ...
    function categoriesInit() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#categories_constructions").html(populateCategories(categories));
                ...
                $( ".sortable" ).sortable({
                    ...
                    stop:function () {
                        ...
                        $.ajax({
                            url: "/api/order_categories_constructions/",
                            type: "POST",
                            data: {ids: ids},
                            dataType: "json",
                            success: function (response) {
            ...
            buttons: {
                formSubmit: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            url: "/api/categories_constructions/" + id + "?name=" + name,
                            type: "PUT",
                            dataType: "json",
                            success: function (response) {
    ...
    function deleteCategory(id) {
        ...
        $.confirm({
            ...
            buttons: {
                ...
                Sim: function () {
                    $.ajax({
                        url: "/api/categories_constructions/" + id,
                        type: "DELETE",
                        dataType: "json",
                        success: function (response) {
