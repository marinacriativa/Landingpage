    ...
    <main class="listing-page collapsable-main no-load" data-type="clients">
        <div class="p-desktop-5">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1>{{ ucfirst($translations["backoffice"]["title_list_team"]) }}</h1>
                        ...
                        <div class="text-zero top-right-button-container">
                            <div class="btn-group">
                                <a href="javascript:void(0)" type="button"
                                   ...
                                   style="padding: 9px 34px;">{{ ucfirst($translations["backoffice"]["team_btn_new_member"]) }}</a>
                            </div>
                        </div>
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ ucfirst($translations["backoffice"]["team"]) }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="d-block d-md-inline-block">
                                <div class="btn-group float-md-left mr-1 mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item order-menu" data-order="dt">{{ ucfirst($translations["backoffice"]["orderBy_date"]) }}</a>
                                    </div>
                                </div>
                ...
                <div class="modal-body modal-body-fullscreen">
                    <div class="container">
                        <div class="mb-2">
                            ...
                            <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                                <ol class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a data-dismiss="modal" href="javascript:void(0)">{{ ucfirst($translations["backoffice"]["team"]) }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ ucfirst($translations["backoffice"]["title_edit_member"]) }}</li>
                                </ol>
                            </nav>
                        </div>
                        <form>
                            <div class="card unset-shadow">
                                <ul class="nav nav-tabs separator-tabs ml-0 mb-5" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active pl-2 pr-2" data-toggle="tab" href="#personal-info-user" role="tab" aria-controls="personal-info-user" aria-selected="true">{{ ucfirst($translations["backoffice"]["team_member_information"]) }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link pl-2 pr-2" data-toggle="tab" href="#notification-config-user" role="tab" aria-controls="notification-config-user" aria-selected="true">{{ ucfirst($translations["backoffice"]["team_member_notifications"]) }}</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="personal-info-user" role="tabpanel" aria-labelledby="personal-info">
                                        <div class="row">
                                            <div class="col-xs-12 col-lg-6 col-xl-6">
                                                <h4>{{ ucfirst($translations["backoffice"]["team_member_credentials"]) }}</h4>
                                                <div class="separator mb-3"></div>
                                                <div class="form-group position-relative error-l-100">
                                                    <label>{{ ucfirst($translations["backoffice"]["team_member_fill_email"]) }} *</label>
                                                    <input type="email" class="form-control" name="email" placeholder="Endereço de email" autocomplete="off">
                                                </div>
                                                <div class="form-group position-relative error-l-100">
                                                    <label>{{ ucfirst($translations["backoffice"]["team_member_fill_password"]) }} *</label>
                                                    <input type="text" class="form-control" name="password" placeholder="Única e segura" autocomplete="off">
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-12 ">
                                                        <label>{{ ucfirst($translations["backoffice"]["team_member_status"]) }}</label>
                                                        <select class="form-control" name="isactive">
                                                            <option value="1">{{ ucfirst($translations["backoffice"]["team_member_status_active"]) }}</option>
                                                            <option value="0">{{ ucfirst($translations["backoffice"]["team_member_status_inactive"]) }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-lg-6 col-xl-6">
                                                <h4>{{ ucfirst($translations["backoffice"]["team_member_personal_info"]) }}</h4>
                                                <div class="separator mb-3"></div>
                                                <div class="form-row">
                                                    <div class="form-group error-l-100 col">
                                                        <label>{{ ucfirst($translations["backoffice"]["team_member_fill_name"]) }}</label>
                                                        <input type="text" name="name" id="addNewMemberName" class="form-control" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col">
                                                        <label>{{ ucfirst($translations["backoffice"]["team_member_fill_phone"]) }}</label>
                                                        <input type="number" name="phone" class="form-control" autocomplete="off" placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="form-group col-12 ">
                                                        <label>{{ ucfirst($translations["backoffice"]["team_member_role"]) }}</label>
                                                        <select class="form-control" name="role">
                                                            <option value="0">{{ ucfirst($translations["backoffice"]["team_member_admin"]) }}</option>
                                                            <option value="1">{{ ucfirst($translations["backoffice"]["team_member_teacher"]) }}</option>
                                                            <option value="2">{{ ucfirst($translations["backoffice"]["team_member_student"]) }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-100 row m-0">
                                            <div class="default pull-left-margin ">
                                                <a type="button" class="btn btn-outline-info btn-xs m-1 ml-2 save-button" href="javascript:void(0)">{{ ucfirst($translations["backoffice"]["team_member_btn_save"]) }}</a>
                                                <a type="button" class="btn btn-outline-danger btn-xs m-1 ml-2 delete-button" href="javascript:void(0)">{{ ucfirst($translations["backoffice"]["team_member_btn_remove"]) }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="notification-config-user" role="tabpanel" aria-labelledby="notification-config-user">
                                        <div class="row">
                                            <div class="col-12">
                                                <h4>{{ ucfirst($translations["backoffice"]["team_member_permissions_notifications"]) }}</h4>
                                                <div class="separator mb-3"></div>
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        <label>{{ ucfirst($translations["backoffice"]["member_notifications_clients"]) }}</label>
                                                        <select class="form-control" name="notification_new_client">
                                                            <option value="1">{{ ucfirst($translations["backoffice"]["member_notifications_active"]) }}</option>
                                                            <option value="0">{{ ucfirst($translations["backoffice"]["member_notifications_inactive"]) }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        <label>{{ ucfirst($translations["backoffice"]["member_notifications_order"]) }}</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        <label>{{ ucfirst($translations["backoffice"]["member_notifications_ticket"]) }}</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        <label>{{ ucfirst($translations["backoffice"]["member_notifications_contact"]) }}</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-12">
                                                        <label>{{ ucfirst($translations["backoffice"]["member_notifications_stock"]) }}</label>
                                        ...
                                        <div class="w-100 row m-0">
                                            <div class="default pull-left-margin ">
                                                <a type="button" class="btn btn-outline-info btn-xs m-1 ml-2 save-button" href="javascript:void(0)">{{ ucfirst($translations["backoffice"]["member_notifications_save"]) }}</a>
                                                <a type="button" class="btn btn-outline-danger btn-xs m-1 ml-2 delete-button" href="javascript:void(0)">{{ ucfirst($translations["backoffice"]["member_notifications_remove"]) }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        */
        ...
        function populate(items) {
            ...
            if (items === undefined || items.length == 0) {
                ...
                $(".list").html(`
                            <h4>{{ ucfirst($translations["backoffice"]["team_empty"]) }}</h4>
                        `);
            }
        }
        ...
        function listners() {
            ...
            $(".delete-button").on("click", function() {
                ...
                $.confirm({
                    title: '{{ ucfirst($translations["backoffice"]["confirm"]) }}',
                    theme: "supervan",
                    content: '{{ ucfirst($translations["backoffice"]["confirm_message_remove_member"]) }}',
                    buttons: {
