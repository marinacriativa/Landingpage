								...
								<div class="card sw-main sw-theme-default">
									<div class="card-body pt-0">
                                        <ul class="card-header pl-0 pb-0 nav nav-tabs step-anchor tproduto">
                                            ...
                                            <li class="nav-item pr-2 is-digital">
                                                <a data-type="2" data-toggle="tab" href="#customizedProduct" role="tab" class="nav-link type2 pl-0 font-weight-700 typeProduct" data-type="2" aria-controls="second" aria-selected="false">{{ ucfirst($translations["backoffice"]["edit_product_type_custom"]) }} <br><small>À medida do cliente</small></a>
                                            </li>
                                        </ul>
