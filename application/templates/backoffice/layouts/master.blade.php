{{-- O perfect scrollbar só funciona quando o jquery esta fora do html --}}
<script src="/static/backoffice/javascript/jquery.js"></script>
<script src="/static/backoffice/javascript/jquery-ui.js"></script> 
<html lang="pt">
    <head></head>
        <meta charset="UTF-8">
        <title>{!! json_decode($website_config->title, true)[$selected_language->code] !!} | @yield('title')</title>
...
touch-action: none !important;
        ...
        <nav class="navbar fixed-top"
            ...
            <a href="/adm" style="flex-basis: 20%; width: 0" class="navbar-logo active">
                <div class="logo"
                    style="background: url({{ $website_config->logo }}) no-repeat; background-size: contain;"></div>
            </a>
            <div class="navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute scroll drop-clients2" id="notificationDropdown">
                            <div class="row mb-2">
                                <div class="col-6 align-self-center">
                                    <h3 class="mb-0">{{ ucfirst($translations["backoffice"]["clients"]) }}</h3>
                                </div>
                                <div class="btn-group col-6">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" onclick="deleteMultipleNotifications()"> {{ ucfirst($translations["backoffice"]["mark_selected_read"]) }} <i class="simple-icon-ban pl-1 align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                            <hr class="mb-3">
                ...
                <div class="position-relative d-inline-block header-icons align-middle">
                        ...
                        <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute scroll drop-orders2" id="notificationDropdown">
                            <div class="row mb-2">
                                <div class="col-6 align-self-center">
                                    <h3 class="mb-0">{{ ucfirst($translations["backoffice"]["orders"]) }}</h3>
                                </div>
                                <div class="btn-group col-6">
                                    <div class="btn btn-primary btn-xs btn-lg pl-3 pr-0">
                                        <label class="custom-control custom-checkbox mb-0 d-inline-block">
                ...
                @if(MODULES_MESSAGES)
                    <div class="position-relative d-inline-block header-icons align-middle">
                        ...
                        <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute scroll drop-messages2" id="notificationDropdown">
                            <div class="row mb-2">
                                <div class="col-6 align-self-center">
                                    <h3 class="mb-0">{{ ucfirst($translations["backoffice"]["messages"]) }}</h3>
                                </div>
                                <div class="btn-group col-6">
                                    <div class="btn btn-primary btn-xs btn-lg pl-3 pr-0">
                                        <label class="custom-control custom-checkbox mb-0 d-inline-block">
                ...
                <div class="user d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right-offset mt-1 account-dropdown">
                        <a class="dropdown-item" href="/">
                            <i class="simple-icon-basket p-2 w-40"></i> {{ ucfirst($translations["backoffice"]["store"]) }}
                        </a>
                        <a class="dropdown-item" href="/adm/team">
                            <i class="simple-icon-user p-2 w-40"></i> {{ ucfirst($translations["backoffice"]["users"]) }}
                        </a>
                        <a class="dropdown-item" href="/adm/config">
                            <i class="simple-icon-settings p-2 w-40"></i> {{ ucfirst($translations["backoffice"]["settings"]) }}
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/logout">
                            <i class="simple-icon-logout p-2 w-40"></i> {{ ucfirst($translations["auth"]["logout"]) }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="main-menu">
                <div class="scroll">
                    <ul class="list-unstyled">
                        <li>
                            <a href="/adm">
                                <i class="iconsmind-Home"></i>{{ ucfirst($translations["backoffice"]["home"]) }}
                            </a>
                        </li>
                        @if(MODULES_COUPONS)
                        <li>
                        ...
                        <li>
                            <a href="/adm/orders">
                                <i class="iconsmind-Box-Close"></i>{{ ucfirst($translations["backoffice"]["orders"]) }}
                            </a>
                        </li>
                        @endif
                        
                        @if(MODULES_HOMEPAGE && $user['role'] == '0')
                        <li>
                            <a href="/adm/homepages">
                                <i class="iconsmind-Box-Close"></i>{{ ucfirst($translations["backoffice"]["homepage"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_CLIENTS)
                        <li>
                            <a href="/adm/clients">
                                <i class="iconsmind-Mens"></i>{{ ucfirst($translations["backoffice"]["clients"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_JOBS)
                        ...
                        @if(MODULES_PRODUCTS)
                            <li>
                                <a class="link-sub" href="#products">
                                    <i class="iconsmind-Shopping-Bag"></i>{{ ucfirst($translations["backoffice"]["products"]) }}
                                </a>
                            </li>
                        @endif
                        @if(MODULES_PAGES)
                        <li>
                            <a href="/adm/pages">
                                <i class="iconsmind-digital-drawing"></i>{{ ucfirst($translations["backoffice"]["pages"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_DOCUMENTS)
                        <li>
                            <a href="/adm/documents">
                                <i class="iconsmind-files"></i>{{ ucfirst($translations["backoffice"]["documents"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_INFO_FORM)
                        <li>
                            <a href="/adm/info-form">
                                <i class="iconsmind-files"></i>{{ ucfirst($translations["backoffice"]["info_form_tilte"]) }}
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="/adm/menus">
                                <i class="iconsmind-arrow-inside"></i>{{ ucfirst($translations["backoffice"]["menu_manager"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_POPUPS)
                        <li>
                            <a href="/adm/popups">
                                <i class="iconsmind-window"></i>{{ ucfirst($translations["backoffice"]["title_popup"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_CUSTOM_PAGE)
                        <li>
                            <a href="/adm/custom_page/1">
                                <i class="iconsmind-info-window"></i>{{ ucfirst($translations["backoffice"]["custom_page_title"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_CUSTOM_INFO)
                        <li>
                            <a href="/adm/custom_info/1">
                                <i class="iconsmind-information"></i>{{ ucfirst($translations["backoffice"]["custom_info_title"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_ALERTS)
                        <li>
                            <a href="/adm/alerts">
                                <i class="iconsmind-bell"></i>{{ ucfirst($translations["backoffice"]["title_alerts"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_PARTNERS)
                        <li>
                            <a href="/adm/partners">
                                <i class="iconsmind-bell"></i>{{ ucfirst($translations["backoffice"]["brands"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_RANKING_BLOCKS)
                        <li>
                            <a href="/adm/ranking_blocks">
                                <i class="iconsmind-bell"></i>{{ ucfirst($translations["backoffice"]["title_ranking_blocks"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_CYCLES_BLOCKS)
                        <li>
                            <a href="/adm/cycles_blocks">
                                <i class="iconsmind-bell"></i>{{ ucfirst($translations["backoffice"]["title_cycles_blocks"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_BANNERS)
                        <li>
                            <a href="/adm/banners">
                                <i class="iconsmind-switch"></i>{{ ucfirst($translations["backoffice"]["banner_title"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_NEWS)
                        <li>
                            <a href="#news">
                                <i class="iconsmind-Newspaper"></i>{{ ucfirst($translations["backoffice"]["news"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_RECRUITMENTS)
                        <li>
                            <a href="/adm/recruitments">
                                <i class="iconsmind-Jet"></i>{{ ucfirst($translations["backoffice"]["recruitments"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_GALLERY)
                        <li>
                            <a href="/adm/galleries">
                                <i class="iconsmind-Photos"></i>{{ ucfirst($translations["backoffice"]["gallery"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_MESSAGES)
                        <li>
                            <a class="link-sub" href="#mensagem">
                                <i class="iconsmind-Envelope-2"></i>{{ ucfirst($translations["backoffice"]["messages"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_SERVICES)
                            <li>
                                <a href="/adm/services">
                                    <i class="iconsmind-wrench"></i> {{ ucfirst($translations["backoffice"]["services"]) }}
                                </a>
                            </li>
                        @endif
                        @if(MODULES_TEAM)
                        <li>
                            <a href="/adm/team">
                                <i class="iconsmind-King-2"></i>{{ ucfirst($translations["backoffice"]["users"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_SCHEDULE)
                        <li>
                            <a href="/adm/schedule">
                                <i class="iconsmind-calendar-4"></i>{{ ucfirst($translations["backoffice"]["schedule"]) }}
                            </a>
                        </li>
                        @endif
                        ...
                        @endif
                        @if(MODULES_TESTIMONIES)
                        <li>
                            <a href="/adm/testimonies">
                                <i class="iconsmind-Testimonal"></i> {{ ucfirst($translations["backoffice"]["testimonies"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_IMPORTED_DATAS)
                        <li>
                            <a href="/adm/imported_datas">
                                <i class="iconsmind-Testimonal"></i> {{ ucfirst($translations["backoffice"]["imported_datas"]) }}
                            </a>
                        </li>
                        @endif
                        @if(MODULES_SETTINGS)
                        <li>
                            <a href="/adm/config">
                                <i class="iconsmind-Gear"></i> {{ ucfirst($translations["backoffice"]["settings"]) }}
                            </a>
                        </li>
                        @endif
                    </ul>
            ...
            <div class="sub-menu">
                <div class="scroll">
                    ...
                    <ul class="list-unstyled" data-link="products">
                        <li>
                            <a href="/adm/products">
                                <i class="iconsmind-Shopping-Cart"></i> {{ ucfirst($translations["backoffice"]["products"]) }}
                            </a>
                        </li>
                        @if(MODULES_PERSONALIZATION)
                            <li>
                                <a href="/adm/personalization">
                                    <i class="simple-icon-layers"></i> {{ ucfirst($translations["backoffice"]["custom"]) }}
                                </a>
                            </li>
                        @endif
                        @if(MODULES_BRANDS)
                        ...
                        @if(MODULES_CATEGORIES)
                            <li>
                                <a href="/adm/categories">
                                    <i class="simple-icon-list"></i> {{ ucfirst($translations["backoffice"]["categories"]) }}
                                </a>
                            </li>
                        @endif
                        @if(MODULES_FILTERS)
                            <li>
                                <a href="/adm/filters">
                                    <i class="simple-icon-list"></i> {{ ucfirst($translations["backoffice"]["filters"]) }}
                                </a>
                            </li>
                        @endif
                        <li>
                    ...
                    <ul class="list-unstyled" data-link="mensagem">
                        @if(MODULES_TICKETS)
                            <li>
                                <a href="/adm/tickets">
                                    <i class="iconsmind-Envelope-2"></i> {{ ucfirst($translations["backoffice"]["tickets"]) }}
                                </a>
                            </li>
                        @endif
                        <li>
                            <a href="/adm/contacts">
                                <i class="iconsmind-Globe-2"></i> {{ ucfirst($translations["backoffice"]["contact_request"]) }}
                            </a>
                        </li>
                        <li>
                            <a href="/adm/newsletter">
                                <i class="iconsmind-Full-View2"></i> {{ ucfirst($translations["backoffice"]["newsletter"]) }}
                            </a>
                        </li>
                    </ul>
                    <!-- Sub-menu portfolio -->
                    @if(MODULES_PORTFOLIO)
                        <ul class="list-unstyled" data-link="portfolio">
                            @if(MODULES_CONSTRUCTIONS)
                                <li>
                                    <a href="/adm/constructions">
                                        <i class="iconsmind-wheelbarrow"></i> {{ ucfirst($translations["backoffice"]["constructions"]) }}
                                    </a>
                                </li>
                            @endif
                            @if(MODULES_SERVICES)
            ...
            function populateNotifications(notifications) {
                ...
                if (notifications != undefined) {
                    ...
                    if (!notificationsPerTypes.ticket?.length && !notificationsPerTypes.message?.length && !notificationsPerTypes.contact?.length) {
                        ...
                        $("#divNotifications").html("{{ ucfirst($translations["backoffice"]["empty_notifications"]) }}");
                                ...
                                `<div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    ...
                                    <div class="pl-3 notification col-9" data-id="` + notificationTicket.id + `">
                                        <a class="notification" href="` + notificationTicket.link + `" data-id="` + notificationTicket.id + `">
                                            <p class="font-weight-medium mb-1">{{ ucfirst($translations["backoffice"]["new"]) }} {{ $translations["backoffice"]["ticket"] }}</p>
                                    ...
                                    <div class="col-2">
                                        <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right markasread" title="{{ ucfirst($translations["backoffice"]["mark_as_read"]) }}" data-id="` + notificationTicket.id + `">
                                ...
                                `<div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                    ...
                                    <div class="pl-3 notification col-9" data-id="` + notificationMessage.id + `">
                                        <a class="notification" href="` + notificationMessage.link + `" data-id="` + notificationMessage.id + `">
                                            <p class="font-weight-medium mb-1">{{ ucfirst($translations["backoffice"]["new_female"]) }} {{ $translations["backoffice"]["message"] }}:</p>
                                    ...
                                    <div class="col-2">
                                        <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right markasread" title="{{ ucfirst($translations["backoffice"]["mark_as_read"]) }}" data-id="` + notificationMessage.id + `">
                                            <i class="simple-icon-ban"></i>
                                        </button>
                                    </div>
                                </div>`;
                                ...
                                `<div class="d-flex flex-row mb-3 pb-3 border-bottom row">
                                    ...
                                    <div class="pl-3 notification col-8" data-id="` + notificationContact.id + `">
                                        <a class="notification" href="` + notificationContact.link + `" data-id="` + notificationContact.id + `">
                                            <p class="font-weight-medium mb-1">{{ ucfirst($translations["backoffice"]["new"]) }} {{ $translations["backoffice"]["contact_request"] }}</p>
                                            <p class="text-muted mb-0 text-small">` + notificationContact.date + `</p>
                                        </a>
                                    </div>
                                    <div class="col-1">
                                        <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right markasread" title="{{ ucfirst($translations["backoffice"]["mark_as_read"]) }}" data-id="` + notificationContact.id + `">
                                            <i class="simple-icon-ban"></i>
                                        </button>
                                    </div>
                                </div>`;
                    ...
                    if (!notificationsPerTypes.order?.length) {
                        ...
                        $("#divNewOrders").html("{{ ucfirst($translations["backoffice"]["empty_notifications"]) }}")
                            ...
                            `<div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                ...
                                <div class="pl-3 notification col-9" data-id="` + notificationOrder.id + `">
                                    <a class="notification" href="` + notificationOrder.link + `" data-id="` + notificationOrder.id + `">
                                        <p class="font-weight-medium mb-1">{{ ucfirst($translations["backoffice"]["new"]) }} {{ $translations["backoffice"]["order"] }}</p>
                                ...
                                <div class="col-2">
                                    <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right markasread" title="{{ ucfirst($translations["backoffice"]["mark_as_read"]) }}" data-id="` + notificationOrder.id + `">
                                        <i class="simple-icon-ban"></i>
                                    </button>
                                </div>
                            </div>`;
                    ...
                    if (!notificationsPerTypes.client?.length) {
                        ...
                        $("#divNewClients").html("{{ ucfirst($translations["backoffice"]["empty_notifications"]) }}");
                        ...
                        $.each(notificationsPerTypes.client, function (key, notificationClient) {
                            ...
                            `<div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                ...
                                <div class="col-2">
                                    <button class="btn btn-outline-danger mb-1 btn-xs m-1 float-right markasread" title="{{ ucfirst($translations["backoffice"]["mark_as_read"]) }}" data-id="` + notificationClient.id + `">
                                        <i class="simple-icon-ban"></i>
                                    </button>
                                </div>
                            </div>`;
